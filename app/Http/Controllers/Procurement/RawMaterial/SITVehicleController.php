...
class SITVehicleController extends Controller
{
    ...
    public function getList(Request $request)
    {
        $purchaseTickets = PurchaseTicket::where('freight_status', 'completed')
            ...
            ->where('purchase_tickets.company_id', $request->company_id)
            ->whereNotNull('purchase_tickets.purchase_order_id')
            ->latest()
            ->paginate($request->get('per_page', 25));

        return view('management.procurement.raw_material.sit_vehicles.getList', compact('purchaseTickets'));
    }
    ...
    public function create(Request $request)
    {
        ...
        // $html = view('management.procurement.raw_material.sit_vehicles.partials.freight_form', [
        //     'purchaseOrder' => $ticket,
        //     'stations' => $stations,
        //     'bagTypes' => $bagTypes
        // ])->render();

        return view('management.procurement.raw_material.sit_vehicles.create', compact('stations', 'bagTypes', 'ticket', 'bagTypes'));
    }
    ...
    public function edit($id)
    {
        ...
        $freight = PurchaseFreight::with(['purchaseOrder', 'station'])
        ...
        return view('management.procurement.raw_material.sit_vehicles.edit', compact('ticket', 'freight', 'stations', 'bagTypes'));
    }
    ...
    public function getPurchaseOrderDetails(Request $request)
    {
        ...
        $html = view('management.procurement.raw_material.sit_vehicles.partials.purchase_order_details', [
