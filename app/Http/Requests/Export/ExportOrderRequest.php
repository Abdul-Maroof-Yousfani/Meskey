...
class ExportOrderRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'consignee_id' => ['nullable', 'exists:customer_consignees,id'],
            ...
            'packing_items.*.thread_color_id' => ['required', 'exists:colors,id'],
            ...
            'packing_items.*.no_of_bags' => ['required', 'numeric', 'min:1'],
            'packing_items.*.min_weight_empty_bags' => ['required', 'numeric', 'min:0'],
            'packing_items.*.extra_bags_percentage' => ['nullable', 'numeric', 'min:0'],
            'packing_items.*.empty_bags_percentage' => ['nullable', 'numeric', 'min:0'],
            ...
            'packing_items.*.sub_items.*.empty_bags_percentage' => ['nullable', 'numeric', 'min:0'],
            'packing_items.*.sub_items.*.extra_bags_percentage' => ['nullable', 'numeric', 'min:0'],
