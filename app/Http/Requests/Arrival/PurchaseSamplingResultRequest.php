...
class PurchaseSamplingResultRequest extends FormRequest
{
    /**
    ...
    public function rules(): array
    {
        return [
            ...
            'purchase_sampling_request_id' => 'required|exists:purchase_sampling_requests,id',
    ...
    public function messages(): array
    {
        return [
            ...
            'purchase_sampling_request_id.required' => 'Purchase Sampling Request ID is required.',
            'purchase_sampling_request_id.exists' => 'Invalid Purchase Sampling Request ID.',
