...
class ArrivalCompulsoryQcParamSeeder extends Seeder
{
    public function run()
    {
        ...
        $params = [
            ...
            ['name' => 'Bad Smell', 'type' => 'dropdown', 'options' => json_encode(['No', 'Yes']),  'properties' => ['is_protected_for_inner_req' => false], 'calculation_base_type' => 3],
            ['name' => 'Heat Up', 'type' => 'dropdown', 'options' => json_encode(['No', 'Yes']),  'properties' => ['is_protected_for_inner_req' => false], 'calculation_base_type' => 3],
            ['name' => 'Fungus', 'type' => 'dropdown', 'options' => json_encode(['No', 'Yes']),  'properties' => ['is_protected_for_inner_req' => false], 'calculation_base_type' => 3],
            ['name' => 'Live Insects', 'type' => 'dropdown', 'options' => json_encode(['No', 'Yes']),  'properties' => ['is_protected_for_inner_req' => false], 'calculation_base_type' => 3],
            ['name' => 'Web', 'type' => 'dropdown', 'options' => json_encode(['No', 'Yes']),  'properties' => ['is_protected_for_inner_req' => false], 'calculation_base_type' => 3],
            ['name' => 'Dyed Color', 'type' => 'dropdown', 'options' => json_encode(['No', 'Yes']),  'properties' => ['is_protected_for_inner_req' => false], 'calculation_base_type' => 3],
