<table class="table m-0">
    <thead>
        <tr>
            ...
            <th class="col-sm-3">Account Title</th>
            <th class="col-sm-3">Bank Name</th>
            <th class="col-sm-2">IBAN</th>
                ...
                <tr>
                    ...
                    <td>
                        ...
                        <a class="info p-1 text-center position-relative "
                            onclick="openModal(this,'{{ route('bank.edit', $bank->id) }}','Edit Bank Account')">
                            <i class="ft-edit font-medium-3"></i></a>
                        @endcanAccess
                        @canAccess('bank-show')
                        <a class="info p-1 text-center position-relative "
                            onclick="openModal(this,'{{ route('bank.show', $bank->id) }}','Show Bank Account')">
                            <i class="ft-eye font-medium-3"></i></a>
                        @endcanAccess
                        @canAccess('bank-delete')
                        <a onclick="deletemodal('{{ route('bank.destroy', $bank->id) }}','{{ route('get.bank') }}')"
