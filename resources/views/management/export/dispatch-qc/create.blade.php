<form action="{{ route('export-dispatch-qc.store') }}" method="POST" id="ajaxSubmit" autocomplete="off" enctype="multipart/form-data">
    @csrf
    ...
    <div class="row" id="ticketDataContainer" style="margin-left: 4px; margin-right: 4px;"></div>
