<form action="{{ route('incoterm.update', $term->id) }}" method="POST" id="ajaxSubmit" autocomplete="off">
    @csrf
    @method('PUT')
    <input type="hidden" id="listRefresh" value="{{ route('get.incoterm') }}" />
    ...
    <div class="row">
        ...
        <div class="col-xs-12 col-sm-12 col-md-12 mt-2">
            <div class="form-group">
                ...
                <textarea name="description" placeholder="Description" class="form-control" rows="3">{{ $term->description }}</textarea>
            </div>
        </div>
