            ...
            @foreach($loadingPrograms as $loadingProgram)
                ...
                <tr>
                    ...
                    <td>
                        ...
                        <a onclick="openModal(this,'{{ route('export-loading-program-complete.show', $loadingProgram->id) }}','View Loading Program', false, '90%')"
                            class="info p-1 text-center mr-1 position-relative" title="View">
                            <i class="ft-eye font-medium-3"></i>
                        </a>
                        <a onclick="openModal(this,'{{ route('export-loading-program-complete.edit', $loadingProgram->id) }}','Complete Loading Program', false, '90%')"
                            class="warning p-1 text-center mr-1 position-relative" title="Add Items">
            ...
            <tr class="ant-table-placeholder">
                <td colspan="6" class="ant-table-cell text-center">
                    <div class="my-5">
                        ...
                        <p class="ant-empty-description">No Pending Loading Programs found</p>
                    </div>
                </td>
            </tr>
        @endif
