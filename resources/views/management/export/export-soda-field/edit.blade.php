            ...
            <div class="row">
                <div class="col-md-4">
                    <div class="form-group">
                        ...
                        <input type="number" step="0.01" name="price_per_kg" placeholder="Rate Per KG" class="form-control" value="{{ number_format($exportSodaField->price_per_kg, 2, '.', '') }}" />
                    </div>
                </div>
                <div class="col-md-4">
                    <div class="form-group">
                        <label>Rate Per Mound:</label>
                        <input type="number" step="0.01" name="price_per_mound" placeholder="Rate Per Mound" class="form-control" value="{{ number_format($exportSodaField->price_per_mound, 2, '.', '') }}" />
                    </div>
                </div>
                <div class="col-md-4">
                    <div class="form-group">
                        <label>Rate Per 100KG:</label>
                        <input type="number" step="0.01" name="price_per_100_kg" placeholder="Rate Per 100KG" class="form-control" value="{{ number_format($exportSodaField->price_per_100_kg, 2, '.', '') }}" />
                    </div>
                </div>
            </div>
            ...
            <div class="row">
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <input type="number" step="0.01" name="quantity_in_kg" id="quantity_in_kg" placeholder="Quantity in KG" class="form-control" value="{{ number_format($exportSodaField->quantity_in_kg, 2, '.', '') }}" />
                    </div>
                </div>
                <div class="col-md-6">
                    <div class="form-group">
                        <label>Quantity in Ton:</label>
                        <input type="number" step="0.01" name="quantity_in_ton" id="quantity_in_ton" placeholder="Quantity in Ton" class="form-control" value="{{ number_format($exportSodaField->quantity_in_ton, 2, '.', '') }}" />
                    </div>
                </div>
            </div>
