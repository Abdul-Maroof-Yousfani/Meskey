    ...
    <div class="row form-mar">
        <div class="col-xs-12 col-sm-12 col-md-12">
            <div class="form-group">
                <label>Ticket:</label>
                <input type="text" value="{{ $ExportQc->loadingProgramItem->transaction_number ?? 'N/A' }} -- {{ $ExportQc->loadingProgramItem->truck_number ?? 'N/A' }}"
    ...
    <div class="row">
        <div class="col-xs-12 col-sm-6 col-md-6">
            <div class="form-group">
                ...
                <textarea class="form-control" readonly>{{ $ExportQc->qc_remarks }}</textarea>
            </div>
        </div>
        <div class="col-xs-12 col-sm-6 col-md-6">
            <div class="form-group">
                <label>Status:</label>
                <input type="text" value="{{ ucfirst($ExportQc->status) }}"
                    disabled class="form-control" autocomplete="off" readonly />
            </div>
        </div>
    </div>
...
@if($ExportQc->status === 'reject')
    <x-approval-without-revert :model="$ExportQc" />
@endif
