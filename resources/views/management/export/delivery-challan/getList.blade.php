                                ...
                                @if($isFirstRow)
                                    ...
                                    <td rowspan="{{ $group['rowspan'] }}" class="text-center align-middle">
                                        <div class="btn-group" role="group">
                                            ...
                                            <a 
                                               class="btn btn-sm btn-info" onclick="openModal(this,'{{ route('export-delivery-challan.view', ['delivery_challan' => $group['id']]) }}','View Export Delivery Challan', false, '60%')" title="View" style="margin-right: 10px;">
                                                <i class="ft-eye"></i>
                                            </a>
                        ...
                        <tr>
                            <td colspan="8" class="text-center py-5">
                                <div class="my-5">
                                    ...
                                    <p class="text-muted mt-3">No Export Delivery Challan found</p>
                                </div>
                            </td>
                        </tr>
                    @endforelse
