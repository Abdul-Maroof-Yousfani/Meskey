...
<div id="exportDeliveryOrderShow">
            ...
            <div class="row">
                <div class="col-md-3">
                    <div class="form-group">
                        <label>Buyer:</label>
                        <input type="text" class="form-control" value="{{ $deliveryOrder->customer->name ?? '' }}" disabled>
                    </div>
                </div>
                <div class="col-md-3">
                    <div class="form-group">
                        <label>Export Order:</label>
                        <input type="text" class="form-control" value="#{{ $deliveryOrder->exportOrder->voucher_no ?? '' }}" disabled>
                    </div>
                </div>
                <div class="col-md-3">
                    <div class="form-group">
                        <label>Form-E Select: <span class="text-danger">*</span></label>
                        <select name="export_form_e_id" id="export_form_e_id_edit" class="form-control select2" disabled>
                ...
                <div class="packing-item row border-bottom pb-3 mb-3 w-100 mx-auto" style="display:none;" id="dummyPackingRow">
                        ...
                        <div class="col-md-1">
                            <div class="form-group">
                                ...
                                <input type="number" name="packing_items[0][no_of_bags]" class="form-control no-of-bags" style="background-color: #fff9e6; border-color: #ffc107;" disabled>
                            </div>
                        </div>
                        <div class="col-md-1">
                            <div class="form-group">
    ...
    <table class="sub-packing-item-template d-none">
                <tbody>
                    <tr class="sub-packing-item-row">
                        ...
                        <td>
                            <!-- Master No. of Bags editable nhi hogi, it should be auto-calculated and readonly -->
    ...
    <div class="row form-mar mt-3">
        <div class="col-md-12">
            <div class="form-group">
                <label>Remarks:</label>
                <textarea name="remarks" class="form-control" rows="3" disabled>{{ $deliveryOrder->remarks }}</textarea>
            </div>
        </div>
    </div>
...
<style>
    ...
    #exportDeliveryOrderShow .remove-btn {
        display: none !important;
    }
    #exportDeliveryOrderShow input, #exportDeliveryOrderShow select {
        pointer-events: none;
    }
</style>
<script>
