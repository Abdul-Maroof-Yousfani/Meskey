        ...
        <section id="extended">
            <div class="row w-100 mx-auto">
                <div class="col-xs-6 col-sm-6 col-md-6 col-lg-6">
                    <h2 class="page-title">Proforma</h2>
                </div>
                <div class="col-xs-6 col-sm-6 col-md-6 col-lg-6 text-right">
                    <a href="{{ route('proforma.select.export-order') }}" class="btn btn-primary position-relative ">
                        Create Proforma
                    </a>
                    {{-- <button onclick="openModal(this,'{{ route('proforma.create') }}','Add Proforma',false,'90%')"
...
@section('script')
    <script>
        $(document).ready(function() {
            filterationCommon(`{{ route('get.proforma') }}`)
        });
    </script>
@endsection
