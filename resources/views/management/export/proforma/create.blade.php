...
<form action="{{ route('proforma.store', $exportOrder->id) }}" method="POST" id="ajaxSubmit" autocomplete="off">
    ...
    <div class="row form-mar">
        <div class="col-8">
                    ...
                    <div class="col-md-4">
                        <div class="form-group">
                            ...
                            <input type="date" name="shipment_delivery_date_from" class="form-control"
                                value="{{ old('shipment_delivery_date_from', $exportOrder->shipment_delivery_date_from ? \Carbon\Carbon::parse($exportOrder->shipment_delivery_date_from)->format('Y-m-d') : '') }}"
                                disabled>
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="form-group">
                            ...
                            <input type="date" name="shipment_delivery_date_to" class="form-control"
                                value="{{ old('shipment_delivery_date_to', $exportOrder->shipment_delivery_date_to ? \Carbon\Carbon::parse($exportOrder->shipment_delivery_date_to)->format('Y-m-d') : '') }}"
                                disabled>
                        </div>
                    </div>
            ...
            <div class="col-md-12 mt-4" id="proforma-packing-section">
                    ...
                    <div class="p-3">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-12 mb-2">
                                ...
                                <input type="text" class="form-control" value="{{ $exportOrder->customerBank ? $exportOrder->customerBank->bank_name . ' (' . ($exportOrder->customer_bank_type == 'owner' ? 'Owner' : ($exportOrder->customer_bank_type == 'company' ? 'Company' : 'Shipper')) . ')' : 'N/A' }}" disabled>
            ...
            <div class="row p-2">
                ...
                <div class="col-md-4">
                    <div class="form-group">
                        ...
                        <textarea name="other_condition" id="force_majure" class="form-control" rows="3" disabled>{{ old('force_majure', $exportOrder->force_majure) }}</textarea>
                    </div>
                </div>
                <div class="col-md-4">
                    <div class="form-group">
...
<script>
    function initializeProformaCreateForm() {
        const $form = $('#ajaxSubmit');
        if ($form.data('proforma-create-initialized')) {
            return;
        }
        $form.data('proforma-create-initialized', true);
    ...
    $(document).ready(initializeProformaCreateForm);
</script>
