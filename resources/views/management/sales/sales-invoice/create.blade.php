...
<script>
    ...
    function addRow() {
        ...
        <tr id="row_${index}">
            ...
            <td style="min-width: 100px;">
                <input type="number" name="no_of_bags[]" id="no_of_bags_${index}" onkeyup="calculateRow(this)" class="form-control no_of_bags" step="any" min="0" readonly>
            </td>
            <td style="min-width: 100px;">
                <input type="number" name="qty[]" id="qty_${index}" onkeyup="calculateRow(this)" class="form-control qty" step="any" min="0">
            </td>
            <td style="min-width: 100px;">
            ...
            <td style="min-width: 100px;">
                <input type="number" name="gst_percent[]" id="gst_percent_${index}" onkeyup="calculateRow(this)" class="form-control gst_percent" step="any" min="0" max="100" value="0">
            </td>
            <td style="min-width: 120px;">
