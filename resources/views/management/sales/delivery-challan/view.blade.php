...
<form action="{{ route('sales.delivery-challan.update', [ 'delivery_challan' => $delivery_challan->id ]) }}" method="POST" id="ajaxSubmit2" autocomplete="off">
    @csrf
    {{ method_field("PUT") }}
                ...
                <div class="col-md-4">
                    <div class="form-group">
                        ...
                        <input type="text" name="dc_no" value="{{ $delivery_challan->dc_no }}" id="dc_no"
                            id="text" class="form-control" readonly>
                    </div>
                </div>
                <div class="col-md-4">
                    <div class="form-group">
                        ...
                        <input type="date" name="date" onchange="getNumber()"
                            value="{{ $delivery_challan->dispatch_date }}" id="date" class="form-control" readonly>
                    </div>
                </div>
                <div class="col-md-4">
                            ...
                            <tr id="row_{{ $index }}">
                                ...
                                <td>
                                    ...
                                    <input type="text" name="" id="bag_type_{{ $index }}"
                                        value="{{ $data->bag_type ? bag_type_name($data->bag_type) : 1 }}" onkeyup="calc(this)"
                                        class="form-control bag_type" step="0.01" min="0" readonly>
                                ...
                                <td>
                                    <input type="text" name="bilty_no[]" id="bilty_no_{{ $index }}"
                                        value="{{ $data->bilty_no }}" class="form-control bilty_no" readonly>
                                </td>
                                <td>
                                    <input type="text" name="desc[]" id="desc_{{ $index }}"
                                        class="form-control" value="{{ $data->desc }}" readonly>
                                </td>
