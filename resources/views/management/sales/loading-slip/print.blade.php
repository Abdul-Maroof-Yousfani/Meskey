        ...
        <div class="header">
            ...
            <div class="company-info">
                <div class="info-row">
                    ...
                    <span class="info-content">Saima Trade Tower, Tower B, Room # 1511-13, I. I. Chundrigar Road,
                        Karachi.</span>
                </div>
                <div class="info-row">
                    <span class="info-label">Factory:</span>
                    <span class="info-content">Plot No A-43, A-45 & A-46, Eastern, Industrial Zone, Port Qasim, Karachi,
                        Pakistan.</span>
                </div>
                <div class="info-row">
                    <span class="info-label">Retail Outlet:</span>
                    <span class="info-content">Shop No. 4, K.A.I Center, Opp City Court, Dandia Bazar, Karachi Ph: +92
                        23 32713369, 3378</span>
                </div>
        ...
        <div class="main-grid">
            <div class="left-col">
                ...
                <div class="field-group">
                    ...
                    <div class="field-value">
                        {{ $loadingSlip->brand ?? $loadingSlip->loadingProgramItem->brand->name ?? '' }}
                    </div>
                </div>
                <div class="field-group">
                    <div class="field-label">Second Weight</div>
                    <div class="field-value">{{ number_format($loadingSlip->secondWeighbridge->second_weight ?? 0, 0) }}
                    </div>
                </div>
                <div class="field-group">
            ...
            <div class="right-col">
                ...
                <div class="field-group">
                    ...
                    <div class="field-value">{{ number_format($loadingSlip->secondWeighbridge->first_weight ?? 0, 0) }}
                    </div>
                </div>
                <div class="field-group">
                    <div class="field-label">Gaala</div>
                    <div class="field-value">{{ $loadingSlip->loadingProgramItem->subArrivalLocation->name ?? '' }}
                    </div>
                </div>
                <div class="field-group">
                ...
                <div class="field-group">
                    ...
                    <div class="field-value">{{ number_format($loadingSlip->secondWeighbridge->net_weight ?? 0, 0) }}
                    </div>
                </div>
                <div class="field-group">
                ...
                <div class="field-group">
                    <div class="field-label">Suggested Qty</div>
                    <div class="field-value">{{ number_format($loadingSlip->loadingProgramItem->qty ?? 0, 0) }}</div>
                </div>
                <div class="field-group">
