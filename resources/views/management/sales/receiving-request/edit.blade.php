    ...
    <div class="row">
        ...
        <div class="col-md-2">
            <div class="form-group">
                ...
                <input type="number" class="form-control bg-light font-weight-bold text-danger" id="penalty_weight" value="{{ number_format($receivingRequest->penalty_weight, 2, '.', '') }}" readonly placeholder="Penalty Weight">
            </div>
        </div>
        <div class="col-md-2">
            <div class="form-group">
                <label class="font-weight-bold">Payment Weight</label>
                <input type="number" class="form-control bg-light font-weight-bold text-primary" id="payment_weight" value="{{ number_format(floatval($receivingRequest->arrived_weight), 2, '.', '') }}" readonly placeholder="Payment Weight">
            </div>
        </div>
    </div>
