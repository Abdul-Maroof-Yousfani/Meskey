...
<form action="{{ route('sales.sales-return.update', ['sales_return' => $saleReturn->id]) }}" method="POST" id="ajaxSubmit" autocomplete="off">
    @csrf
    {{ method_field("PUT") }}
                ...
                <div class="col-md-4">
                    <div class="form-group">
                        ...
                        <select name="company_location_id" id="locations"
                            onchange="selectLocation(this); get_sale_invoices()" class="form-control select2">
                ...
                <div class="col-md-4">
                    <div class="form-group">
                        ...
                        <input type="text" name="reference_number" value="{{ $saleReturn->reference_number }}"
                            id="reference_number" class="form-control" placeholder="Enter reference number">
                    </div>
                </div>
                <div class="col-md-4">
                    <div class="form-group">
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="form-group">
                        ...
                        <textarea name="remarks" id="remarks" class="form-control" rows="2" placeholder="Enter remarks">{{ $saleReturn->remarks }}</textarea>
                    </div>
                </div>
            </div>
        </div>
                            ...
                            <tr id="row_{{ $rowIndex }}">
                                ...
                                <td style="min-width: 100px;">
                                    <input readonly type="number" name="packing[]" id="packing_{{ $rowIndex }}"
                                        onkeyup="" class="form-control packing" step="0.01"
                                ...
                                <td style="min-width: 100px;">
                                    <input readonly type="number" name="rate[]" id="rate_{{ $rowIndex }}"
                                        onkeyup="" class="form-control rate" step="0.01"
                                        min="0" value="{{ $rate }}">
                                </td>
                                ...
                                <td style="min-width: 120px;">
                                    <input readonly type="number" name="discount_amount[]"
                                        ...
                                        step="0.01" min="0" value="{{ $discountAmount }}">
                                </td>
                                <td style="min-width: 120px;">
                                ...
                                <td style="min-width: 100px;">
                                    <input readonly type="number" name="gst_percent[]"
                                        id="gst_percent_{{ $rowIndex }}"
                                        class="form-control gst_percent" step="0.01" min="0"
                                        value="{{ $gstPercent }}">
                                </td>
                                <td style="min-width: 120px;">
                                    <input readonly type="number" name="gst_amount[]"
                                        id="gst_amount_{{ $rowIndex }}" class="form-control gst_amount"
                                        step="0.01" min="0" value="{{ $gstAmount }}">
                                </td>
                                <td style="min-width: 120px;">
...
<script>
    ...
    function addRow() {
        ...
        <tr id="row_${index}">
            ...
            <td style="min-width: 100px;">
                <input type="number" name="packing[]" id="packing_${index}" onkeyup="" class="form-control packing" step="0.01" min="0">
            </td>
            <td style="min-width: 100px;">
                <input type="number" name="no_of_bags[]" id="no_of_bags_${index}" onkeyup="" class="form-control no_of_bags" step="0.01" min="0">
            </td>
            <td style="min-width: 100px;">
                <input type="number" name="qty[]" id="qty_${index}" class="form-control qty" step="0.01" min="0" readonly>
            </td>
            <td style="min-width: 100px;">
                <input type="number" name="rate[]" id="rate_${index}" onkeyup="" class="form-control rate" step="0.01" min="0">
            </td>
            <td style="min-width: 120px;">
            ...
            <td style="min-width: 120px;">
                <input readonly type="number" name="discount_amount[]" id="discount_amount_${index}" class="form-control discount_amount" readonly value="0">
            </td>
            <td style="min-width: 120px;">
                <input readonly type="number" name="amount[]" id="amount_${index}" class="form-control amount" readonly value="0">
            </td>
            <td style="min-width: 100px;">
            ...
            <td style="min-width: 120px;">
                <input readonly type="number" name="gst_amount[]" id="gst_amount_${index}" class="form-control gst_amount" readonly value="0">
            </td>
            <td style="min-width: 120px;">
