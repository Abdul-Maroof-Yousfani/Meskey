                ...
                <div class="field-row">
                    ...
                    <div class="field-value">
                        @if($DispatchQc->loadingProgramItem->deliveryOrders->isNotEmpty())
                            {{ $DispatchQc->loadingProgramItem->deliveryOrders->map(function($do) { return $do->reference_no . ($do->is_auto_created_from_so ? " (Dummy DO)" : ""); })->implode(', ') }}
                        @else
                            {{ $DispatchQc->loadingProgramItem->loadingProgram->deliveryOrder ? $DispatchQc->loadingProgramItem->loadingProgram->deliveryOrder->reference_no . ($DispatchQc->loadingProgramItem->loadingProgram->deliveryOrder->is_auto_created_from_so ? " (Dummy DO)" : "") : 'N/A' }}
                        @endif
                    </div>
                </div>
                <div class="field-row">
