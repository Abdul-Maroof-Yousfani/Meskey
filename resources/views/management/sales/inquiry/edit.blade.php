    ...
    <div class="row form-mar">
        ...
        <div class="col-md-4">
            <div class="form-group">
                ...
                <input type="date" name="inquiry_date" onchange="getNumber()" id="inquiry_date" value="{{ $sales_inquiry->date }}" class="form-control">
            </div>
        </div>
        ...
        <div class="col-md-4 mt-3">
            <div class="form-group">
                ...
                <input type="text" name="contact_person" id="contact_person" value="{{ $sales_inquiry->contact_person }}" class="form-control">
            </div>
        </div>
                ...
                <table class="table table-bordered" id="salesInquiryTable" style="min-width:2000px;">
                    ...
                    <tbody id="salesInquiryBody">
                        ...
                        @foreach($sales_inquiry->sales_inquiry_data as $index => $data)
                            <tr id="row_{{ $index }}">
                                <td>
                                    <select name="item_id[]" id="item_id_{{ $i }}" class="form-control select2">
                                ...
                                <td>
                                    <input type="number" name="qty[]" id="qty_{{ $i }}" value="{{ $data->qty }}" class="form-control" step="0.01" min="0">
                                </td>
                                <td>
                                    <input type="number" name="rate[]" id="rate_{{ $i }}" value="{{ $data->rate }}" class="form-control" step="0.01" min="0">
                                </td>
                                <td>
                                    <input type="text" name="desc[]" id="desc_{{ $i }}" value="{{ $data->description }}" class="form-control">
                                </td>
                                <td>
                                    <button type="button" class="btn btn-danger btn-sm removeRowBtn" onclick="removeRow({{ $i }})" style="width:60px;">
