                        ...
                        @foreach($group['items'] as $itemRow)
                            <tr>
                                ...
                                @if($isFirstRow)
                                    ...
                                    <td rowspan="{{ $group['rowspan'] }}" class="align-middle text-center font-weight-bold">{{ $group["inquiry_no"] }}</td>
                                ...
                                @if($isFirstRow)
                                    ...
                                    <td rowspan="{{ $group['rowspan'] }}" class="text-center align-middle">
                                        <div class="btn-group" role="group">
                                            ...
                                            <a 
                                               class="btn btn-sm btn-info" onclick="openModal(this,'{{ route('sales.sale-order.view', ['id' => $group['id']]) }}','View Sales Order', false, '60%')" title="View" style="margin-right: 10px;">
                                                <i class="ft-eye"></i>
                                            </a>
                                            @if(auth()->user()->id == $group['created_by_id'])
                                                @if($group['status'] === 'pending' || $group['status'] === 'reverted')
                                                <button 
                                                    onclick="openModal(this,'{{ route('sales.sale-order.edit', ['sale_order' => $group['id']]) }}','Edit Sale Order', false, '60%')"
