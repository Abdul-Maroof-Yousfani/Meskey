<div class="header-navbar navbar-expand-sm navbar navbar-horizontal navbar-fixed navbar-light navbar-shadow menu-border navbar-brand-center"
    ...
    <div class="navbar-container main-menu-content center-layout" data-menu="menu-container">
        <ul class="navigation-main nav navbar-nav" id="main-menu-navigation" data-menu="menu-navigation">
            ...
            @endcanAccess
            @canAccess('arrival')
            <li class="dropdown nav-item {{ request()->is('arrival*') ? 'active' : '' }}" data-menu="dropdown"><a
            ...
            <li class="dropdown nav-item {{ request()->is('procurement/raw-material*') ? 'active' : '' }}"
                ...
                <ul class="dropdown-menu">
                    ...
                    @canAccess("procurement-gate-buying")
                    <li data-menu=""><a class="dropdown-item d-flex align-items-center"
            ...
            @endcanAccess
            @canAccess('finance')
            <li class="dropdown nav-item {{ request()->is('finance*') ? 'active' : '' }}" data-menu="dropdown"><a
                    class="dropdown-toggle nav-link d-flex align-items-center" href="javascript:;"
                    ...
                    <ul class="dropdown-menu">
                        ...
                        <li class="dropdown dropdown-submenu" data-menu="dropdown-submenu"><a
                            ...
                            <ul class="dropdown-menu">
                                ...
                                <li data-menu="">
                                    <a class="dropdown-item d-flex align-items-center"
                                        href="{{ route('shipment-company.index') }}"
                                        onclick="loadPageContent('{{ route('shipment-company.index') }}')"
                                        data-toggle="dropdown"><i class="ft-arrow-right submenu-icon"></i>
                                ...
                                <li data-menu="">
                                    <a class="dropdown-item d-flex align-items-center" href="{{ route('gafta.index') }}"
                                        onclick="loadPageContent('{{ route('gafta.index') }}')"
                                        data-toggle="dropdown"><i class="ft-arrow-right submenu-icon"></i>
                                ...
                                <li data-menu="">
                                    <a class="dropdown-item d-flex align-items-center"
                                        href="{{ route('shipment-country.index') }}"
                                        onclick="loadPageContent('{{ route('shipment-country.index') }}')"
                                        data-toggle="dropdown"><i class="ft-arrow-right submenu-icon"></i>
                                ...
                                <li data-menu="">
                                    <a class="dropdown-item d-flex align-items-center"
                                        href="{{ route('working-days.index') }}"
                                        onclick="loadPageContent('{{ route('working-days.index') }}')"
                                        data-toggle="dropdown"><i class="ft-arrow-right submenu-icon"></i>
                                ...
                                <li data-menu="">
                                    <a class="dropdown-item d-flex align-items-center"
                                        href="{{ route('document-list.index') }}"
                                        onclick="loadPageContent('{{ route('document-list.index') }}')"
                                        data-toggle="dropdown"><i class="ft-arrow-right submenu-icon"></i>
                        ...
                        <li data-menu=""><a class="dropdown-item d-flex align-items-center"
                                ...
                                onclick="loadPageContent('{{ route('packing-list.index') }}')" data-toggle="dropdown"><i
                                    class="ft-arrow-right submenu-icon"></i><span data-i18n="Extended">Packing
                                    List</span></a>
                        </li>
            ...
            @endcanAccess
            @canAccess('reports')
            <li class="dropdown nav-item {{ request()->is('reports*') ? 'active' : '' }}" data-menu="dropdown"><a
                    class="dropdown-toggle nav-link d-flex align-items-center" href="javascript:;"
                ...
                <ul class="dropdown-menu">
                    ...
                    <li class="dropdown dropdown-submenu" data-menu="dropdown-submenu">
                        ...
                        <ul class="dropdown-menu">
                            ...
                            <li data-menu="">
                                <a class="dropdown-item d-flex align-items-center"
                                    href="{{ route('station-wise-qc-analysis.index') }}"
                                    onclick="loadPageContent('{{ route('station-wise-qc-analysis.index') }}')"
                                    data-toggle="dropdown">
            ...
            @endcanAccess
            @canAccess('master')
            <li class="dropdown nav-item {{ request()->is('master*') ? 'active' : '' }}" data-menu="dropdown"><a
                    class="dropdown-toggle nav-link d-flex align-items-center" href="javascript:;"
                ...
                <ul class="dropdown-menu">
                    ...
                    <li class="dropdown dropdown-submenu" data-menu="dropdown-submenu"><a
                        ...
                        <ul class="dropdown-menu">
                            ...
                            <li data-menu=""><a class="dropdown-item d-flex align-items-center"
                                    ...
                                    onclick="loadPageContent('{{ route('size.index') }}')" data-toggle="dropdown"><i
                                        class="ft-arrow-right submenu-icon"></i><span
                    ...
                    <li class="dropdown dropdown-submenu" data-menu="dropdown-submenu"><a
                        ...
                        <ul class="dropdown-menu">
                            ...
                            @endcanAccess
                            @canAccess('plant-breakdown-type')
                            <li data-menu=""><a class="dropdown-item d-flex align-items-center"
                                    href="{{ route('plant-breakdown-type.index') }}"
                                    onclick="loadPageContent('{{ route('plant-breakdown-type.index') }}')"
                                    data-toggle="dropdown"><i class="ft-arrow-right submenu-icon"></i><span
                                        data-i18n="Extended">Plant Breakdown Type</span></a>
                            </li>
                            @endcanAccess
                        </ul>
                    </li>
