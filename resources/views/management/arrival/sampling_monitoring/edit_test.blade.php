...
@endphp
<form action="{{ route('sampling-monitoring.update-test', $arrivalSamplingRequest->id) }}" method="POST" id="ajaxSubmit"
    autocomplete="off">
    @csrf
    @method('PUT')
        ...
        <div class="col-md-5">
            <div class="row form-mar">
                ...
                <div class="col-xs-6 col-sm-6 col-md-6">
                    <fieldset data-toggle="collapse" href="#collapse11" aria-expanded="false"
                ...
                <div class="col-xs-12 col-sm-12 col-md-12">
                    <div id="collapse1" role="tabpanel" aria-labelledby="headingCollapse11" class="cllapse " style="">
                        <div class="row form-mar">
                            <!-- Ticket Number -->
                            {{-- <div class="col-xs-6 col-sm-6 col-md-6">
                                <fieldset>
                                    <div class="input-group">
                                        ...
                                        <input type="text" disabled class="form-control"
                                            value="{{ optional($arrivalSamplingRequest->arrivalTicket)->unique_no ?? 'N/A' }}">
                                    </div>
                                </fieldset>
                            </div> --}}
                                ...
                                <div class="form-group">
                                    ...
                                    <select name="arrival_purchase_order_id" id="arrival_purchase_order_id"
                                        ...
                                        @foreach ($arrivalPurchaseOrders as $arrivalPurchaseOrder)
                                            <option value="{{ $arrivalPurchaseOrder->id }}"
                                                @selected(optional($arrivalSamplingRequest->arrivalTicket)->arrival_purchase_order_id == $arrivalPurchaseOrder->id)>
                                                #{{ $arrivalPurchaseOrder->contract_no ?? 'N/A' }} - Type:
                                                {{ $arrivalPurchaseOrder->saudaType->name ?? 'N/A' }}
                                            </option>
                                        @endforeach
                                    </select>
                                </div>
                            ...
                            <div class="col-xs-6 col-sm-6 col-md-6">
                                <div class="form-group">
                                    <label>Product:</label>
                                    <input type="text" disabled class="form-control"
                                        value="{{ optional(optional($arrivalSamplingRequest->arrivalTicket)->product)->name ?? 'N/A' }}"
                            ...
                            <div class="col-xs-6 col-sm-6 col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" disabled class="form-control"
                                        value="{{ optional($arrivalSamplingRequest->arrivalTicket)->saudaType->name ?? 'N/A' }}"
                                        placeholder="Sauda Type">
                                </div>
                            </div>
                            ...
                            <div class="col-xs-6 col-sm-6 col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" disabled
                                        value="{{ optional($arrivalSamplingRequest->arrivalTicket)->miller->name ?? 'N/A' }}">
                                </div>
                            </div>
                            ...
                            <div class="col-xs-6 col-sm-6 col-md-6">
                                <div class="form-group">
                                    <label>Broker:</label>
                                    <input type="text" class="form-control" disabled
                                        value="{{ optional($arrivalSamplingRequest->arrivalTicket)->broker_name ?? 'N/A' }}">
                                </div>
                            </div>
                            ...
                            <div class="col-xs-6 col-sm-6 col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" disabled
                                        value="{{ optional(optional($arrivalSamplingRequest->arrivalTicket)->decisionBy)->name ?? 'N/A' }}">
                                </div>
                            </div>
                            ...
                            <div class="col-xs-6 col-sm-6 col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" disabled
                                        value="{{ optional($arrivalSamplingRequest->arrivalTicket)->accounts_of_name ?? 'N/A' }}">
                                </div>
                            </div>
                            ...
                            <div class="col-xs-6 col-sm-6 col-md-6">
                                <div class="form-group">
                                    <label>Station:</label>
                                    <input type="text" class="form-control" disabled
                                        value="{{ optional(optional($arrivalSamplingRequest->arrivalTicket)->station)->name ?? 'N/A' }}">
                                </div>
                            </div>
                            ...
                            <div class="col-xs-6 col-sm-6 col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control text-uppercase" disabled
                                        value="{{ optional($arrivalSamplingRequest->arrivalTicket)->truck_no ?? 'N/A' }}">
                                </div>
                            </div>
                            ...
                            <div class="col-xs-6 col-sm-6 col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" disabled
                                        value="{{ optional($arrivalSamplingRequest->arrivalTicket)->bilty_no ?? 'N/A' }}">
                                </div>
                            </div>
                            ...
                            <div class="col-xs-6 col-sm-6 col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" disabled
                                        value="{{ optional(optional($arrivalSamplingRequest->arrivalTicket)->truckType)->name ?? 'N/A' }}">
                                </div>
                            </div>
                            ...
                            {{-- <div class="col-xs-6 col-sm-6 col-md-6">
                                <div class="form-group">
                                    ...
                                    <select class="form-control" disabled>
                                        <option {{ optional($arrivalSamplingRequest->arrivalTicket)->sample_money_type
                                            == 'n/a' ? 'selected' : '' }} value="n/a">N/A</option>
                                        <option {{ optional($arrivalSamplingRequest->arrivalTicket)->sample_money_type
                                            == 'single' ? 'selected' : '' }} value="single">Single</option>
                                        <option {{ optional($arrivalSamplingRequest->arrivalTicket)->sample_money_type
                                            == 'double' ? 'selected' : '' }} value="double">Double</option>
                                    </select>
                                </div>
                            </div>
                            ...
                            <div class="col-xs-6 col-sm-6 col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" disabled
                                        value="{{ optional($arrivalSamplingRequest->arrivalTicket)->bags ?? '0' }}">
                                </div>
                            </div>
                            ...
                            <div class="col-xs-6 col-sm-6 col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" disabled
                                        value="{{ optional($arrivalSamplingRequest->arrivalTicket)->loading_date ? \Carbon\Carbon::parse($arrivalSamplingRequest->arrivalTicket->loading_date)->format('Y-m-d') : 'N/A' }}">
                                </div>
                            </div>
                            ...
                            <div class="col-xs-4 col-sm-4 col-md-4">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" disabled
                                        value="{{ optional($arrivalSamplingRequest->arrivalTicket)->first_weight ?? '0' }}">
                                </div>
                            </div>
                            ...
                            <div class="col-xs-12 col-sm-12 col-md-12">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" disabled
                                        value="{{ optional($arrivalSamplingRequest->arrivalTicket)->net_weight ?? '0' }}">
                                </div>
                            </div>
                            ...
                            <div class="col-xs-12 col-sm-12 col-md-12">
                                <div class="form-group">
                                    ...
                                    <textarea class="form-control" disabled
                                        rows="3">{{ optional($arrivalSamplingRequest->arrivalTicket)->remarks ?? 'N/A' }}</textarea>
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <div class="row">
                <div class="col-xs-12 col-sm-12 col-md-12">
                    <div class="form-group">
                        ...
                        <input type="text" disabled="" class="form-control"
                            value="{{ $arrivalSamplingRequest->arrivalProduct->name ?? '' }}" placeholder="QC Product">
                    </div>
                </div>
            ...
            <div id="slabsContainer">
                ...
                <ul class="nav nav-tabs" id="qcChecklistTabs" role="tablist">
                    @if (!empty($initialRequestsData))
                        @foreach ($initialRequestsData as $index => $initialData)
                            ...
                            @endphp
                            <li class="nav-item">
                                <a class="nav-link" id="initial-{{ $index }}-tab" data-toggle="tab" href="#initial-{{ $index }}"
                                    role="tab" aria-controls="initial-{{ $index }}" aria-selected="false">
                                    <div>{{ $statusLabel }}</div>
                                    <small
                    ...
                    @foreach ($innerRequestsData as $index => $innerData)
                        ...
                        @endphp
                        <li class="nav-item">
                            <a class="nav-link" id="inner-{{ $index }}-tab" data-toggle="tab" href="#inner-{{ $index }}"
                                role="tab" aria-controls="inner-{{ $index }}" aria-selected="false">
                                <div>{{ $statusLabel }}</div>
                                <small
                ...
                <div class="tab-content" id="qcChecklistTabsContent">
                            ...
                            <div class="tab-pane fade" id="initial-{{ $index }}" role="tabpanel"
                                        ...
                                        @foreach ($initialData['results'] as $slab)
                                            ...
                                            <div class="form-group row checklist-box">
                                                ...
                                                <div class="col-md-2 QcResult">
                                                    <div class="input-group mb-0">
                                                        <input type="text" class="form-control bg-white" value="{{ $deductionValue }}"
                                ...
                                <div class="striped-rows">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-md-3">
                                            <div class="custom-control custom-switch">
                                                <input type="checkbox" name="is_lumpsum_deduction_initial"
                                                    class="custom-control-input" id="lumpsum-toggle-initial-{{ $index }}"
                                        ...
                                        <div class="col">
                                            <div class="input-group mb-1">
                                                <input type="text" id="lumpsum-value-initial-{{ $index }}" class="form-control"
                                        ...
                                        <div class="col-md-3">
                                            <div class="custom-control custom-switch">
                                                <input type="checkbox" name="decision_making_initial"
                                                    class="custom-control-input" id="decision_making_initial_{{ $index }}"
                    ...
                    <div class="tab-pane fade show active" id="current-inner" role="tabpanel"
                                ...
                                @foreach ($results as $slab)
                                    ...
                                    <div class="form-group row checklist-box">
                                        ...
                                        <div class="col-md-2 QcResult">
                                            ...
                                            @if(in_array($slab->slabType->calculation_base_type, [2, 3]))
                                                <div class="input-group mb-0 mt-1">
                                                    <input type="text" id="deduction-maund-{{ $slab->slabType->id }}"
                                                        class="form-control deduction-maund-field" name="applied_deduction_maund[]"
                                ...
                                @foreach ($Compulsuryresults as $slab)
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div
                                            ...
                                            @else
                                                <textarea class="form-control {{ $compulsaryClass }}"
                                                    name="compulsory_checklist_value[]" readonly>{{ $displayCompValue }}</textarea>
                                            @endif
                                        </div>
                                        @if (!checkIfNameExists($slab->qcParam->name))
                                            <div class="col-md-2 QcResult">
                        ...
                        <div class="striped-rows mt-3">
                            <div class="form-group row">
                                <label class="col-md-4 label-control font-weight-bold" for="lumpsum-toggle">Apply
                                    Lumpsum
                                    Deduction</label>
                                <div class="col-md-3">
                                    <div class="custom-control custom-switch">
                        ...
                        for (let slab of matchingSlabs) {
                            ...
                            if (val >= from) {
                                ...
                                if (effectiveFrom <= effectiveTo) {
                                    if (isTiered === 1) {
                                        // Tiered calculation: per unit deduction
            ...
            if ($(this).is(':checked')) {
                Swal.fire({
                    ...
                    if (result.isConfirmed) {
                        ...
                        $('.deduction-maund-field').val('').prop('readonly', true);
                        $('#lumpsum-value').prop('readonly', false);
                        $('#lumpsum-kgs-value').prop('readonly', false);
                        $('#lumpsum-maund').prop('readonly', false);
                        $('#lumpsum-kgs-maund').prop('readonly', false);
                        calculateTotal();
                    } else {
                ...
                $('.deduction-maund-field').prop('readonly', false);
                $('#lumpsum-value').prop('readonly', true).val('0');
                $('#lumpsum-kgs-value').prop('readonly', true).val('0');
                $('#lumpsum-maund').prop('readonly', true).val('0');
                $('#lumpsum-kgs-maund').prop('readonly', true).val('0');
                calculateTotal();
            }
        });
