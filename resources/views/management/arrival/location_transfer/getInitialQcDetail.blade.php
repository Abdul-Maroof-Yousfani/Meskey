<div class="row">
    <div class="col-xs-12 col-sm-12 col-md-12" bis_skin_checked="1">
        <div class="form-group " bis_skin_checked="1">
            <label data-name="Product">Ticket Commodity:</label>
            <input type="text" value="{{ optional($initialRequestForInnerReq->arrivalTicket)->product->name ?? '-' }}"
                disabled="" placeholder="Qc Product" class="form-control" autocomplete="off">
        </div>
    </div>
    <div class="col-xs-12 col-sm-12 col-md-12" bis_skin_checked="1">
        <div class="form-group " bis_skin_checked="1">
            <label data-name="QC Product">QC Commodity:</label>
            <input type="text"
                value="{{ optional($initialRequestForInnerReq->arrivalTicket)->qcProduct->name ?? '-' }}" disabled=""
