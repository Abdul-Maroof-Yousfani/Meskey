        ...
        <form id="ajaxSubmit" action="{{ route('ticket.arrival-revert-test.update', $arrivalTicket->id) }}" method="POST">
            ...
            <div class="row pt-2">
                <div class="col-md-6">
                    ...
                    <input type="hidden" id="url" value="{{ route('ticket.arrival-revert-test', $arrivalTicket->id) }}">
                    <div class="card">
...
<script>
    ...
    $('.maund-field').on('input', calculateTotal);
        ...
        if ($(this).is(':checked')) {
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    ...
                    $('[name="lumpsum_deduction_kgs_maund"]').prop('readonly', false);
                    calculateTotal();
                } else {
            ...
            $('[name="lumpsum_deduction_kgs_maund"]').prop('readonly', true).val('0');
            calculateTotal();
        }
    });
