                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-xs-4 col-sm-4 col-md-4">
                                                <div class="form-group ">
                                                    ...
                                                    <input type="text" placeholder="Accounts Of" class="form-control"
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-xs-4 col-sm-4 col-md-4 d-none">
                                                    <div class="form-group ">
                                                        ...
                                                        <input type="text" name="net_weight" disabled
                                                            placeholder="Net Weight" class="form-control"
                                                            autocomplete="off"
                                                            value="{{ $arrivalTicket->firstWeighbridge->weight - $arrivalTicket->SecondWeighbridge->weight - $arrivalTicket->net_weight }}" />
                                                    </div>
                                                </div>
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-md-4">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="number" name="exempted_weight"
                                                ...
                                                <div class="col-md-4">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="number" name="net_shortage"
                                                            class="form-control"disabled
                                                ...
                                                <div class="col-md-4">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="number" step="0.01"
                                                            name="freight_per_ton"disabled class="form-control"
                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="file" name="bilty_document"disabled
                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="file" name="loading_weight_document"disabled
                                                            class="form-control-file" />
                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="file" name="other_document"disabled
                                                            class="form-control-file" />
                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="file" name="other_document_2"disabled
                                                            class="form-control-file" />
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        @else
                                            <div class="tab-content" id="qcChecklistTabsContent">
                                                                    ...
                                                                    @foreach ($initialData['results'] as $slab)
                                                                        ...
                                                                        <div class="form-group row checklist-box">
                                                                            ...
                                                                            <div class="col-md-3 QcResult">
                                                                                ...
                                                                                @if ($previousChecklistValue !== null)
                                                                                    <span
                                                                                        class="checklist-value-comparison">
                                                                                        Previous:
                                                                                        {{ $previousChecklistValue }}
                                                                                    </span>
                                                                                @endif
                                                                    ...
                                                                    <div class="col">
                                                                        ...
                                                                        <div class="input-group mb-0">
                                                                            <input type="text"
                                                                                ...
                                                                                class="form-control"
                                                                                name="lumpsum_deduction_kgs_initial"
                                                                                readonly
                                                ...
                                                @foreach ($innerRequestsData as $index => $innerData)
                                                    <div class="tab-pane fade" id="inner-{{ $index }}"
                                                        ...
                                                        <div class="striped-rows mt-3">
                                                            <div class="form-group row">
                                                                <label
                                                                    class="col-md-4 label-control font-weight-bold">Apply
                                                            ...
                                                            <div class="form-group row">
                                                                <label
                                                                    class="col-md-4 label-control font-weight-bold">Decision
                                                                    Making on Avg.</label>
                                                                <div class="col-md-3">
                                                                    <div class="custom-control custom-switch">
                                                                        <input type="checkbox"
                                                ...
                                                @if ($arrivalSamplingRequest)
                                                    <div class="tab-pane fade show active" id="current-inner"
                                                        role="tabpanel" aria-labelledby="current-inner-tab">
                                                        <div class="row w-100 mx-auto">
                                                            <div class="col-md-4"></div>
                                                            <div class="col-md-3 py-2 QcResult">
                                                                <h6>Result</h6>
                                                            ...
                                                            @if (count($results) != 0)
                                                                @foreach ($results as $slab)
                                                                    @php
                                                                        ...
                                                                        if ($previousChecklistValue !== null) {
                                                                            if (
                                                                                $displayValue > $previousChecklistValue
                                                                            ) {
                                                                                $comparisonClass = 'checklist-increase';
                                                                            } elseif (
                                                                                $displayValue < $previousChecklistValue
