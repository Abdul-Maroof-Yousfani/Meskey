                    ...
                    <div class="row">
                        ...
                        <div class="col-xs-4 col-sm-4 col-md-4 d-none">
                            <div class="form-group">
                                ...
                                <input type="text" name="net_weight" disabled placeholder="Net Weight" class="form-control"
                                    autocomplete="off"
                                    value="{{ $arrivalTicket->firstWeighbridge->weight - $arrivalTicket->SecondWeighbridge->weight - $arrivalTicket->net_weight }}" />
                            </div>
                        </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <input type="number" step="0.01" disabled name="kanta_golarchi_charges" class="form-control"
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <input type="number" step="0.01" name="karachi_kanta_charges" class="form-control" disabled
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <input type="number" step="0.01" name="other_labour_charges" class="form-control" disabled
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <input type="number" step="0.01" name="unpaid_labor_charges" class="form-control" disabled
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <input type="number" step="0.01" disabled name="freight_written_on_bilty"
                                    class="form-control" value="{{ $arrivalTicket->freight->freight_written_on_bilty }}" />
                            </div>
                        </div>
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="number" step="0.01" name="gross_freight_amount" class="form-control" disabled
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                @if ($arrivalTicket->freight->loading_weight_document)
                                    <a href="{{ asset($arrivalTicket->freight->loading_weight_document) }}" target="_blank">View
                                        Current File</a>
                                @else
                                    <small class="text-danger">No file found</small>
                                @endif
                            ...
                            <div class="tab-pane fade show active" id="current-inner" role="tabpanel"
                                ...
                                <div class="striped-rows mt-3">
                                    <div class="form-group row">
                                        ...
                                        <div class="col-md-3">
                                            <div class="custom-control custom-switch">
                                                <input type="checkbox" class="custom-control-input" id="lumpsum-toggle" disabled
                                        ...
                                        <div class="col">
                                            ...
                                            <div class="input-group mb-0">
                                                <input type="text" id="lumpsum-kgs-value" class="form-control"
                                                    ...
                                                    --}} value="{{ $kgLumpSum ?? 0 }}" readonly placeholder="Lumpsum Deduction">
                                                <div class="input-group-append">
                                                    <span class="input-group-text text-sm">KG's</span>
                                                </div>
                                            </div>
                                        ...
                                        <div class="col-md-3">
                                            <div class="custom-control custom-switch">
                                                <input type="checkbox" name="decision_making" class="custom-control-input"
                                                    id="decision_making" @checked($isDecisionMaking) disabled
