...
<style>
 [readonly]{background-color:white !important}
.flex-head{display:flex;align-items:center;justify-content:left;}
.add-main1 ul{display:flex;align-items:center;justify-content:space-evenly;}
.logo img{width:67%;}
.add-main1 ul{display:flex;align-items:center;justify-content:space-evenly;padding:0;list-style:none;}
.head-add1 h5{font-size:15px;font-weight:700;margin-bottom:6px;}
.head-add1 p{font-size:14px;margin-bottom:8px;}
.add-main2{display:flex;align-items:center;justify-content:space-between;}
a.btn.btn-a{border:2px solid #ddd;color:#000;}
a.btn.btn-a:hover{box-shadow:0 2px 7px rgba(0,0,0,0.28);cursor:pointer;background:#008749;color:#fff !important;}
...
<form action="{{ route('arrival-slip.store') }}" method="POST" id="ajaxSubmit" autocomplete="off">
    ...
    <div class="row form-mar">
        <div class="col-xs-12 col-sm-12 col-md-12 auth-img-bg p-3">
            <div class="flex-head">
                <div class="logo">
                ...
                <div class="logo-cont">
                        ...
                        <ul>
                            <li>
                                <div class="head-add1">
                                    ...
                                    <p>Salma Trade Tower, Tower B, Room # 1511,1512 & 1513,I,I, Chaundrigar Road, Karachi.</p>
                                </div>
                            </li>
                            <li>
                                <div class="head-add1">
                                    <h5><u>Factory:</u></h5>
                                    <p>Plot No A-13,A-15 & A-46, Eastern, Industrial Zone, Port Qasim, Karachi Pakistan.</p>
                                </div>
                            </li>
                            <li>
                                <div class="head-add1">
                                    <h5><u>Retail Outlet:</u></h5>
                                    <p>Shop: No.4, K.A.I Center, Opp City Court, Dandla Bazar, Karachi Ph. +922332713369,3378</p>
                                </div>
                            </li>
                        </ul>
                    </div>
                    ...
                    <div class="add-main2">
                        ...
                        <div class="head-add-btn">
                            <a name="" id="" class="btn btn-a" href="#" role="button">Arrival Slip</a>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <table style="width: 100%; border-collapse: collapse; ">
                    <tr>
                        ...
                        <td style="width: 12%; padding: 8px; border: none;">
                            <input type="text" style="width: 100%; border: 1px solid #ddd; padding: 10px 10px; background: transparent;"
