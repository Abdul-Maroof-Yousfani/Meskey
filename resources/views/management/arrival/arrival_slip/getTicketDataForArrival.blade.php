...
<div class="row form-mar">
    ...
    <div class="col-md-6">
        <div class="form-group">
            ...
            <input type="text" class="form-control bg-light" value="{{ $arrivalTicket->lumpsum_deduction ?? 'N/A' }}"
                readonly>
        </div>
    </div>
    <div class="col-md-6">
    ...
    <div class="col-md-6">
        <div class="form-group">
            ...
            <input type="text" class="form-control bg-light" value="{{ $arrivalTicket->approvals->gala_name ?? 'N/A' }}"
                readonly>
        </div>
    </div>
    <div class="col-md-6">
    ...
    <div class="col-md-3">
        <div class="form-group">
            ...
            <input type="text" class="form-control bg-light" value="{{ $arrivalTicket->net_weight ?? 'N/A' }}" readonly>
        </div>
    </div>
    <div class="col-md-3">
        <div class="form-group">
