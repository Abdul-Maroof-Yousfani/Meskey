                ...
                <div class="col-10">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <form action="{{ route('arrival-slip.store') }}" method="POST" id="ajaxSubmit"
                                autocomplete="off">
                                @csrf
                                <input type="hidden" id="listRefresh" value="{{ route('get.arrival-slip') }}" />
                                <input type="text" class="d-none"
                                    value="{{ $arrivalTicket->arrivalSlip->unique_no ?? 'N/A' }}" />
                                <style>
                                    #printSection {
                                        color: #222 !important;
                                    }
                                        ...
                                        <div class=" col-lg-12 col-md-12 col-sm-12 col-xs-12 auth-img-bg p-3">
                                            <div class="flex-head">
                                                ...
                                                <div class="logo-cont">
                                                        ...
                                                        <ul>
                                                            <li>
                                                                <div class="head-add1">
                                                                    ...
                                                                    <p>Salma Trade Tower, Tower B, Room # 1511,1512 &
                                                                        1513,I,I,
                                                                        Chaundrigar Road,
                                                                        Karachi.</p>
                                                                </div>
                                                            ...
                                                            <li>
                                                                <div class="head-add1">
                                                                    <h5><u>Factory:</u></h5>
                                                                    <p>Plot No A-13,A-15 & A-46, Eastern, Industrial Zone,
                                                                        Port
                                                                        Qasim,
                                                                        Karachi
                                                                        Pakistan.</p>
                                                            ...
                                                            <li>
                                                                <div class="head-add1">
                                                                    ...
                                                                    <p>Shop: No.4, K.A.I Center, Opp City Court, Dandla
                                                                        Bazar,
                                                                        Karachi
                                                                        Ph.
                                                                        +922332713369,3378</p>
                                                    ...
                                                    <div class="add-main2">
                                                        <div class="head-add1">
                                                            <p><strong>Tel:</strong> +923012740216 <strong>Fax:</strong>
                                                            </p>
                                                            <p><strong>Email:</strong> info@mft.com.pk <strong>Web:</strong>
                                                                www.mft.com.pk</p>
                                                        </div>
                                                        <div class="head-add1">
                                                            <h5>
                                                ...
                                                <table style="border-collapse: collapse; ">
                                                    <tr>
                                                        ...
                                                        <td style="padding: 8px; border: none;">
                                                            <input type="text"
                                                                style=" border: 1px solid #ddd; padding: 10px 10px; background: transparent;"
                                                                value="{{ $arrivalTicket->purchaseOrder->contract_no ?? 'N/A' }}"
                                                                readonly>
                                                        </td>
                                                    </tr>
                                                    <tr>
        ...
        : 'RF' }}" readonly>
                                                ...
                                                <div class="row">
                                                    <div class=" col-lg-8 col-md-8 col-sm-8 col-xs-8">
                                                        ...
                                                        <table style="border-collapse: collapse; ">
                                                                ...
                                                                <td style=" padding: 8px;">
                                                                    <div
                                                                        ...
                                                                        <input type="text"
                                                                            ...
                                                                            readonly> <span style="padding: 0 5px;">× 10
                                                                            =</span>
                                                                        <input type="text"
                                                            ...
                                                            <tr>
                                                                <td style=" padding:8px;border:none;">Arrived Kanta Charges
                                                                </td>
                                                                <td style="padding: 8px;">
                                                                    <input type="text"
                                                                ...
                                                                <td style=" padding: 8px;border: none;">Kanta Loading
                                                                    Charges
                                                                </td>
                                                            ...
                                                            <tr>
                                                                <td style=" padding: 8px;border: none;">Other (+)/ Labour
                                                                    Charges
                                                                </td>
                                                            ...
                                                            @endphp
                                                            <tr>
                                                                <td style=" padding: 8px;border: none;">Total Freight
                                                                    Payable
                                                                    (Rs.)
                                                                </td>
                                                                <td style="padding: 8px;">
                                                            ...
                                                            <tr>
                                                                <td style=" padding: 8px;border: none;">Unpaid Labour Charge
                                                                </td>
                                                                <td style="padding: 8px;">
                                                                    <input type="text"
                                                                        style=" border: 1px solid #ddd; padding: 10px 10px;"
                                                    ...
                                                    <div class=" col-lg-4 col-md-4 col-sm-4 col-xs-4">
                                                        ...
                                                        <table style="border-collapse: collapse;">
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td style="padding: 8px;border: none;" colspan="5">
                                                                    <input type="text"
                                                                        style=" border: 1px solid #ddd; padding: 10px 10px;"
                                                                        value="{{ ($arrivalTicket->approvals->total_bags ?? 0) > 0 ? number_format(($arrivalTicket->firstWeighbridge->weight - $arrivalTicket->secondWeighbridge->weight) / $arrivalTicket->approvals->total_bags, 2) : '0.00' }}"
                                                                        readonly>
                                                                </td>
                                                            </tr>
                                                        </table>
                                                        ...
                                                        <div>
                                                            @if ($isCompulsury || $isSlabs || $showLumpSum)
                                                                ...
                                                                <hr
                                                                    style="border: 1px solid #ddd; margin-bottom: 0;margin-top: 0;">
                                                                <table
                                                ...
                                                <div class="signature">
                                                    ...
                                                    <table
                                                        ...
                                                        <tr>
                                                            <td
                                                                style="width: 33%; text-align: center; padding: 8px; vertical-align: top;">
                                                                <div
                                                                    style="font-weight: 800; color: #000; font-size: 1.1rem; margin-bottom: 5px;">
                                                                    Confirmed Form</div>
                                                                <div
                                                                    style="margin-top: 30px; border-top: 1px solid #000; padding-top: 5px;">
                                                ...
                                                @if ($isNotGeneratable)
                                                    <div
                                                        ...
                                                        <strong>Important!</strong> Please apply deductions first before
                                                        generating
                                                        the
                                                        arrival
                                                        slip.
