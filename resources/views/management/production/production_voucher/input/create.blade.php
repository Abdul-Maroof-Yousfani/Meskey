<form method="POST" action="{{ route('production-voucher.input.store', $productionVoucher->id) }}" id="ajaxSubmit" autocomplete="off">
    @csrf
    ...
    <div class="row bottom-button-bar">
        <div class="col-12">
            ...
            <button type="submit" class="btn btn-primary submitbutton">Save Production Input</button>
        </div>
    </div>
</form>
