<form method="POST" action="{{ route('production-voucher.output.store', $productionVoucher->id) }}" id="ajaxSubmit" autocomplete="off">
    @csrf
            ...
            <div class="row">
                ...
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <input type="number" name="no_of_bags" id="output_no_of_bags" class="form-control" step="1" min="0" onchange="calculateAvgWeight()">
                    </div>
                </div>
                ...
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <input type="number" name="avg_weight_per_bag" id="output_avg_weight_per_bag" class="form-control" step="0.001" min="0" readonly>
                    </div>
                </div>
    ...
    <div class="row bottom-button-bar">
        <div class="col-12">
            ...
            <button type="submit" class="btn btn-primary submitbutton">Save Production Output</button>
        </div>
    </div>
</form>
