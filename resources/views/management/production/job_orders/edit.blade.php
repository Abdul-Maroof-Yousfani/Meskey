<form action="{{ route('job-orders.update', $jobOrder->id) }}" method="POST" id="ajaxSubmit" autocomplete="off">
    ...
    <div class="row form-mar">
            ...
            <div class="row">
                <div class="col-md-3">
                    <div class="form-group">
                        ...
                        <input type="text" name="job_order_no" class="form-control" value="{{ $jobOrder->job_order_no }}">
                    </div>
                </div>
                <div class="col-md-3">
                    <div class="form-group">
                        <label>Job Order Date:</label>
                        <input type="date" name="job_order_date" class="form-control" value="{{ $jobOrder->job_order_date->format('Y-m-d') }}">
                    </div>
                </div>
                <div class="col-md-3">
                    <div class="form-group">
                ...
                <div class="col-md-12">
                    <div class="form-group">
                        ...
                        <textarea name="order_description" class="form-control" rows="4">{{ $jobOrder->order_description }}</textarea>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="col-md-12" id="specificationsSection" style="display: {{ $jobOrder->specifications->count() ? 'block' : 'none' }};">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        <td>
                                            ...
                                            <input type="hidden" name="specifications[{{ $index }}][product_slab_id]" value="{{ $spec->product_slab_id }}">
                    ...
                    <div class="col-md-1">
                        <div class="form-group">
                            ...
                            <input type="number" name="packing_items[{{ $packingIndex }}][total_kgs]" 
                                   class="form-control total-kgs" step="0.01" readonly value="{{ $packingItem->total_kgs }}">
                        </div>
                    </div>
                    <div class="col-md-1">
                        <div class="form-group">
                            ...
                            <input type="number" name="packing_items[{{ $packingIndex }}][metric_tons]" 
                                   class="form-control metric-tons" step="0.01" readonly value="{{ $packingItem->metric_tons }}">
                        </div>
                    </div>
                    <div class="col-md-1">
                        <div class="form-group">
                            ...
                            <input type="number" name="packing_items[{{ $packingIndex }}][stuffing_in_container]" 
                                   class="form-control stuffing" step="0.01" value="{{ $packingItem->stuffing_in_container }}">
                        </div>
                    </div>
                    <div class="col-md-2">
                        <div class="form-group">
                    ...
                    <div class="col-md-2">
                        <div class="form-group">
                            ...
                            <input type="number" name="packing_items[{{ $packingIndex }}][min_weight_empty_bags]" 
                                   class="form-control min-weight" step="0.01" value="{{ $packingItem->min_weight_empty_bags }}">
                        </div>
                    </div>
                    <div class="col-md-1">
                        <div class="form-group">
            ...
            <div class="row">
                ...
                <div class="col-md-4">
                    <div class="form-group">
                        ...
                        <textarea name="packing_description" class="form-control" rows="1">{{ $jobOrder->packing_description }}</textarea>
                    </div>
                </div>
            </div>
        </div>
