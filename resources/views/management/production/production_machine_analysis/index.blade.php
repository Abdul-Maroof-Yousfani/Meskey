                                    ...
                                    <div class="col-md-12">
                                        <div class="row">
                                            ...
                                            <div class="col-md-3 text-left">
                                                <label for="production_machine_ids" class="form-label">Machine</label>
                                                <select name="production_machine_ids[]" id="production_machine_ids" class="form-control select2-filter" multiple data-placeholder="Select Machine(s)">
