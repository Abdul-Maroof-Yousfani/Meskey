        ...
        @if (count($divisions) != 0)
            @foreach ($divisions as $key => $division)
                <tr>
                    ...
                    <td>{{ $division->name }}</td>
                    <td>{{ $division->hours ?? '--' }}</td>
                    <td>
                        <span class="badge badge-{{ $division->status == 'active' ? 'success' : 'danger' }}">
                    ...
                    <td>
                        ...
                        <a onclick="deletemodal('{{ route('division.destroy', $division->id) }}','{{ route('get.division') }}')"
