<form action="{{ route('vendor.update', $supplier->id) }}" method="POST" id="ajaxSubmit" autocomplete="off"
        ...
        <div class="col-xs-12 col-sm-12 col-md-12">
            <div class="form-group">
                ...
                <textarea name="address" rows="2" class="form-control"
                    placeholder="Vendor Address">{{ old('address', $supplier->address) }}</textarea>
            </div>
        </div>
    </div>
    ...
    <div class="row bottom-button-bar">
        <div class="col-12">
            <a href="{{ route('vendor.index') }}" class="btn btn-danger position-relative top-1 closebutton">Close</a>
