 <form action="{{ route('customer.update', $customer->id) }}" method="POST" id="ajaxSubmit" autocomplete="off"
     ...
     {{-- <div class="row form-mar mb-2">
         ...
         <div class="col-xs-12 col-sm-12 col-md-12">
             <div class="checkbox">
                 <input name="is_gate_buying_supplier" type="checkbox"
                     {{ $supplier->is_gate_buying_supplier == 'Yes' ? 'checked' : '' }} id="is_gate_buying_supplier"
                     value="Yes">
     ...
     <div class="row">
                ...
                <ul class="list-unstyled mb-0">
                    <li class="d-inline-block mr-2">
                        <div class="radio radio-primary">
                            <input name="nature" type="radio" id="nature_local" value="local"
                                {{ $customer->nature == 'local' ? 'checked' : '' }}>
                    ...
                    <li class="d-inline-block mr-2">
                        <div class="radio radio-primary">
                            <input name="nature" type="radio" id="nature_international" value="international"
                                {{ $customer->nature == 'international' ? 'checked' : '' }}>
         ...
         <div class="col-xs-6 col-sm-6 col-md-6">
             <div class="form-group">
                 ...
                 <input type="text" name="ntn" value="{{ old('ntn', $customer->ntn) }}" placeholder="NTN No"
         ...
         <div class="col-xs-6 col-sm-6 col-md-6">
             <div class="form-group">
                 ...
                 <input type="text" name="stn" value="{{ old('stn', $customer->stn) }}" placeholder="STN No"
                     class="form-control" />
             </div>
         </div>
         <div class="col-xs-12 col-sm-12 col-md-12">
             <div id="card-container" class="mb-4">
                 @if (count($customer->companyBankDetails) > 0)
                     @foreach ($customer->companyBankDetails as $index => $bank)
                 ...
                 <select name="account_id" class="form-control">
                     ...
                     @foreach ($accounts as $account)
                         <option value="{{ $account->id }}"
                             {{ $customer->account_id == $account->id ? 'selected' : '' }}>
     ...
     <div class="row">
         ...
         <div class="col-xs-6 col-sm-6 col-md-6">
             <div class="form-group">
                 ...
                 <input type="text" name="owner_mobile_no" placeholder="03001234567"
                     value="{{ old('owner_mobile_no', $customer->owner_mobile_no) }}" class="form-control"
         ...
         <div class="col-xs-6 col-sm-6 col-md-6">
             <div class="form-group">
                 ...
                 <input type="text" name="owner_cnic_no" placeholder="12345-1234567-1"
                     value="{{ old('owner_cnic_no', $customer->owner_cnic_no) }}" class="form-control cnic-input"
         ...
         <div class="col-xs-12 col-sm-12 col-md-12">
             <div id="card-container2" class="mb-4">
                 @if (count($customer->ownerBankDetails) > 0)
                     @foreach ($customer->ownerBankDetails as $index => $bank)
     ...
     <div class="row">
         ...
         <div class="col-xs-6 col-sm-6 col-md-6">
             <div class="form-group">
                 <label>Name:</label>
                 <input type="text" name="next_to_kin" value="{{ old('next_to_kin', $customer->next_to_kin) }}"
         ...
         <div class="col-xs-6 col-sm-6 col-md-6">
             <div class="form-group">
                 ...
                 <input type="text" name="next_to_kin_mobile_no" placeholder="03001234567" class="form-control"
                     value="{{ old('next_to_kin_mobile_no', $customer->next_to_kin_mobile_no) }}" autocomplete="off"
         ...
         <div class="col-xs-12 col-sm-12 col-md-12">
             <div class="checkbox">
                 <input name="create_as_broker" type="checkbox" id="create_as_broker" value="1"
                     {{ $customer->broker ? 'checked' : '' }}>
                 <label for="create_as_broker"><span>Create/Update this customer as a broker too</span></label>
             </div>
         </div>
     </div>
     ...
     <div class="row">
         ...
         <div class="col-xs-12 col-sm-12 col-md-12">
             <div class="form-group">
                 <label>Address:</label>
                 <textarea name="address" rows="2" class="form-control" placeholder="Customer Address">{{ old('address', $customer->address) }}</textarea>
             </div>
         </div>
     </div>
