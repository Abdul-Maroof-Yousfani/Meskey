<form action="{{ route('customer.store') }}" method="POST" id="ajaxSubmit" autocomplete="off" enctype="multipart/form-data">
    ...
    <div class="row form-mar mb-2">
        ...
        <div class="col-xs-12 col-sm-12 col-md-12">
            <div class="checkbox">
                ...
                <label for="create_as_broker"><span>Create this customer as a broker too</span></label>
            </div>
        </div>
    </div>
    ...
    <div id="consignee-section" class="row" style="display:none;">
        <div class="col-xs-12 col-sm-12 col-md-12">
    ...
    <div class="row ">
        ...
        <div class="col-xs-12 col-sm-12 col-md-12">
            <div class="form-group">
                <label>Address:</label>
                <textarea name="address" rows="2" class="form-control" placeholder="Customer Address"></textarea>
            </div>
        </div>
...
<script>
    ...
    $(document).off('click', '.add-consignee').on('click', '.add-consignee', function(e) {
        e.preventDefault();
        var lastCard = $('#consignee-container .consignee-card:last');
        var newCard = lastCard.clone();
        newCard.find('input').val('');
