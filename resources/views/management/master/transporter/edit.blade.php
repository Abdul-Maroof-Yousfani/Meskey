 <form action="{{ route('transporter.update', $transporter->id) }}" method="POST" id="ajaxSubmit" autocomplete="off"
     enctype="multipart/form-data">
     @csrf
     @method('PUT')
     <input type="hidden" id="listRefresh" value="{{ route('get.transporter') }}" />
 <div class="row form-mar mb-2">
        <div class="col-12">
            <h6 class="header-heading-sepration">
                Gate Buying Transporter
            </h6>
        </div>
        <div class="col-xs-12 col-sm-12 col-md-12">
            <div class="checkbox">
                <input name="is_gate_buying_transporter" type="checkbox" {{ $transporter->is_gate_buying_transporter == 'Yes' ? 'checked' : '' }} id="is_gate_buying_transporter" value="Yes">
                <label for="is_gate_buying_transporter"><span>Gate buying transporter</span></label>
            </div>
        </div>
    </div>
     <div class="row">
          ...
          <div class="col-xs-12 col-sm-12 col-md-12">
            <div class="form-group ">
                ...
                <select class="form-control" name="type">
                    ...
                    <option {{$transporter->type == 'raw_material' ? 'selected' : ''}} value="raw_material" selected>Raw Material Transporter</option>
                    <option {{$transporter->type == 'store_transporter' ? 'selected' : ''}} value="store_transporter">Store Transporter</option>
                </select>
            </div>
        </div>
         <div class="col-xs-12 col-sm-12 col-md-12">
             <div class="form-group">
                 ...
                 <input type="text" name="company_name" value="{{ old('company_name', $transporter->company_name) }}"
         ...
         <div class="col-xs-6 col-sm-6 col-md-6">
             <div class="form-group">
                 ...
                 <input type="text" name="ntn" value="{{ old('ntn', $transporter->ntn) }}" placeholder="NTN No"
         ...
         <div class="col-xs-6 col-sm-6 col-md-6">
             <div class="form-group">
                 ...
                 <input type="text" name="stn" value="{{ old('stn', $transporter->stn) }}" placeholder="STN No"
                     class="form-control" />
             </div>
         </div>
         <div class="col-xs-12 col-sm-12 col-md-12">
             <div id="card-container" class="mb-4">
                 @if (count($transporter->companyBankDetails) > 0)
                     @foreach ($transporter->companyBankDetails as $index => $bank)
                 ...
                 <select name="account_id" class="form-control">
                     ...
                     @foreach ($accounts as $account)
                         <option value="{{ $account->id }}"
                             {{ $transporter->account_id == $account->id ? 'selected' : '' }}>
     ...
     <div class="row">
         ...
         <div class="col-xs-12 col-sm-12 col-md-12">
             <div class="form-group">
                 ...
                 <input type="text" name="owner_name" value="{{ old('owner_name', $transporter->owner_name) }}"
         ...
         <div class="col-xs-6 col-sm-6 col-md-6">
             <div class="form-group">
                 ...
                 <input type="text" name="owner_mobile_no" placeholder="03001234567"
                     value="{{ old('owner_mobile_no', $transporter->owner_mobile_no) }}" class="form-control"
         ...
         <div class="col-xs-6 col-sm-6 col-md-6">
             <div class="form-group">
                 ...
                 <input type="text" name="owner_cnic_no" placeholder="12345-1234567-1"
                     value="{{ old('owner_cnic_no', $transporter->owner_cnic_no) }}" class="form-control cnic-input"
         ...
         <div class="col-xs-12 col-sm-12 col-md-12">
             <div id="card-container2" class="mb-4">
                 @if (count($transporter->ownerBankDetails) > 0)
                     @foreach ($transporter->ownerBankDetails as $index => $bank)
     ...
     <div class="row">
         ...
         <div class="col-xs-6 col-sm-6 col-md-6">
             <div class="form-group">
                 <label>Name:</label>
                 <input type="text" name="next_to_kin" value="{{ old('next_to_kin', $transporter->next_to_kin) }}"
         ...
         <div class="col-xs-6 col-sm-6 col-md-6">
             <div class="form-group">
                 ...
                 <input type="text" name="next_to_kin_mobile_no" placeholder="03001234567" class="form-control"
                     value="{{ old('next_to_kin_mobile_no', $transporter->next_to_kin_mobile_no) }}" autocomplete="off"
         ...
         <div class="col-xs-12 col-sm-12 col-md-12">
             <div class="checkbox">
                 <input name="create_as_broker" type="checkbox" id="create_as_broker" value="1"
                     {{ $transporter->broker ? 'checked' : '' }}>
                 <label for="create_as_broker"><span>Create/Update this transporter as a broker too</span></label>
             </div>
         </div>
     </div>
     ...
     <div class="row">
         ...
         <div class="col-xs-12 col-sm-12 col-md-12">
             <div class="form-group">
                 ...
                 <select name="status" class="form-control">
                     <option value="active" {{ old('status', $transporter->status) == 'active' ? 'selected' : '' }}>
                         Active</option>
                     <option value="inactive" {{ old('status', $transporter->status) == 'inactive' ? 'selected' : '' }}>
                         Inactive</option>
                 </select>
             </div>
         </div>
         <div class="col-xs-12 col-sm-12 col-md-12">
             <div class="form-group">
                 <label>Address:</label>
                 <textarea name="address" rows="2" class="form-control" placeholder="Transporter Address">{{ old('address', $transporter->address) }}</textarea>
             </div>
         </div>
     </div>
