<form action="{{ route('transporter.store') }}" method="POST" id="ajaxSubmit" autocomplete="off"
    ...
    <div class="row form-mar mb-2">
        ...
        <div class="col-xs-12 col-sm-12 col-md-12">
            <div class="checkbox">
                <input name="is_gate_buying_transporter" type="checkbox" id="is_gate_buying_transporter" value="Yes">
        ...
        <div class="col-xs-12 col-sm-12 col-md-12">
            <div class="form-group">
                ...
                <select class="form-control" name="type">
                    ...
                    <option value="raw_material" selected>Raw Material Transporter</option>
                    <option value="store_transporter">Store Transporter</option>
                </select>
            </div>
        </div>
        <div class="col-xs-12 col-sm-12 col-md-12">
    ...
    <div class="row form-mar mb-2">
        ...
        <div class="col-xs-12 col-sm-12 col-md-12">
            <div class="checkbox">
                ...
                <label for="create_as_broker"><span>Create this transporter as a broker too</span></label>
            </div>
        </div>
    </div>
    ...
    <div class="row ">
        ...
        <div class="col-xs-12 col-sm-12 col-md-12">
            <div class="form-group">
                <label>Address:</label>
                <textarea name="address" rows="2" class="form-control" placeholder="Transporter Address"></textarea>
            </div>
        </div>
