 <form action="{{ route('broker.update', $broker->id) }}" method="POST" id="ajaxSubmit" autocomplete="off"
     ...
     <div class="row">
         ...
         <div class="col-xs-12 col-sm-12 col-md-12">
             <div class="form-group">
                 ...
                 <input type="text" name="company_name" value="{{ old('company_name', $broker->company_name) }}"
         ...
         <div class="col-xs-6 col-sm-6 col-md-6">
             <div class="form-group">
                 ...
                 <input type="text" name="ntn" value="{{ old('ntn', $broker->ntn) }}" placeholder="NTN No"
         ...
         <div class="col-xs-6 col-sm-6 col-md-6">
             <div class="form-group">
                 ...
                 <input type="text" name="stn" value="{{ old('stn', $broker->stn) }}" placeholder="STN No"
                     class="form-control" />
             </div>
         </div>
         <div class="col-xs-12 col-sm-12 col-md-12">
             <div id="card-container" class="mb-4">
                 @if (count($broker->companyBankDetails) > 0)
                     @foreach ($broker->companyBankDetails as $index => $bank)
     ...
     <div class="row">
         ...
         <div class="col-xs-12 col-sm-12 col-md-12">
             <div class="form-group">
                 ...
                 <input type="text" name="owner_name" value="{{ old('owner_name', $broker->owner_name) }}"
         ...
         <div class="col-xs-12 col-sm-12 col-md-12">
             <div id="card-container2" class="mb-4">
                 @if (count($broker->ownerBankDetails) > 0)
                     @foreach ($broker->ownerBankDetails as $index => $bank)
     ...
     <div class="row">
         ...
         <div class="col-xs-6 col-sm-6 col-md-6">
             <div class="form-group">
                 <label>Name:</label>
                 <input type="text" name="next_to_kin" value="{{ old('next_to_kin', $broker->next_to_kin) }}"
     ...
     <div class="row">
                 ...
                 <ul class="list-unstyled mb-0">
                     <li class="d-inline-block mr-2">
                         <div class="radio radio-primary">
                             <input name="is_for_sales" type="radio" id="is_for_sales_yes" value="1"
                                 {{ old('is_for_sales', $broker->is_for_sales) == 1 ? 'checked' : '' }}>
         ...
         <div class="col-xs-12 col-sm-12 col-md-12">
             <div class="form-group">
                 <label>Address:</label>
                 <textarea name="address" rows="2" class="form-control" placeholder="broker Address">{{ old('address', $broker->address) }}</textarea>
             </div>
         </div>
     </div>
