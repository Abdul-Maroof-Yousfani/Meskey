                ...
                <tr>
                    ...
                    <td>
                        @foreach ($slabs->pluck('slabType')->unique() as $slabType)
                            <span class="badge badge-primary mr-1">{{ $slabType->name ?? 'N/A' }}</span>
                        @endforeach
                    </td>
                    <td>
                        <a onclick="openModal(this,'{{ route('export-product-slab.edit', $productId) }}','Edit Export Product Slabs')" class="info p-1 text-center mr-2 position-relative">
