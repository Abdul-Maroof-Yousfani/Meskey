         ...
         <div class="col-xs-6 col-sm-6 col-md-6">
             <div class="form-group">
                 ...
                 <input type="text" name="owner_mobile_no"
                     value="{{ old('owner_mobile_no', $supplier->owner_mobile_no) }}" placeholder="Owner Mobile No"
                     class="form-control" autocomplete="off" />
             </div>
         </div>
         <div class="col-xs-6 col-sm-6 col-md-6">
             <div class="form-group">
                 ...
                 <input type="text" name="owner_cnic_no"
                     value="{{ old('owner_cnic_no', $supplier->owner_cnic_no) }}" placeholder="Owner CNIC"
                     class="form-control" autocomplete="off" />
             </div>
         </div>
         <div class="col-xs-12 col-sm-12 col-md-12">
         ...
         <div class="col-xs-6 col-sm-6 col-md-6">
             <div class="form-group">
                 ...
                 <input type="text" name="next_to_kin_mobile_no"
                     value="{{ old('next_to_kin_mobile_no', $supplier->next_to_kin_mobile_no) }}"
