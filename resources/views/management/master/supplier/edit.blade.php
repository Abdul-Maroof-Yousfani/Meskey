<form action="{{ route('supplier.update', $supplier->id) }}" method="POST" id="ajaxSubmit" autocomplete="off"
        ...
        <div class="col-xs-12 col-sm-12 col-md-12">
            <div class="form-group ">
                ...
                <select class="form-control" name="type">
                    ...
                    <option {{$supplier->type == 'raw_material' ? 'selected' : ''}} value="raw_material" selected>Raw
                        Material Supplier</option>
                    <option {{$supplier->type == 'store_supplier' ? 'selected' : ''}} value="store_supplier">Store
                        Supplier</option>
                </select>
            </div>
        </div>
            ...
            @foreach ($companyLocations as $location)
                <div class="checkbox">
                    <input name="company_location_ids[]" type="checkbox" id="location_{{ $location->id }}"
                        value="{{ $location->id }}" {{ in_array($location->id, $selectedLocations) ? 'checked' : '' }}>
    ...
    <div class="d-none row form-mar">
        ...
        <div class="col-xs-12 col-sm-12 col-md-12">
            <div class="checkbox">
                <input name="create_as_broker" type="checkbox" id="create_as_broker" value="1" {{ $supplier->broker ? 'checked' : '' }}>
    ...
    <div class="row">
        ...
        <div class="col-xs-12 col-sm-12 col-md-12">
            <div class="checkbox">
                <input type="checkbox" name="defaulter" value="1" class="custom-control-input" id="defaulter-yes" {{ $supplier->defaulter == 1 ? 'checked' : '' }}>
