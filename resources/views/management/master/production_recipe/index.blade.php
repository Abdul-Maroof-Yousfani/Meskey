        ...
        <section id="extended">
            <div class="row w-100 mx-auto">
                ...
                <div class="col-xs-6 col-sm-6 col-md-6 col-lg-6 text-right">
                    <button
                        onclick="openModal(this,'{{ route('production-recipe.create') }}','Add Production Recipe')"
                        type="button" class="btn btn-primary position-relative">
                        <i class="ft-plus mr-1"></i>Create Production Recipe
                    </button>
                </div>
            </div>
            <div class="row">
                                ...
                                <table class="table m-0">
                                    <thead>
                                        <tr>
                                            ...
                                            <th class="col-sm-2">Crop Year</th>
