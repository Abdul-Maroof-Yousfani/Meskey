<form action="{{ route('clearing-agent.store') }}" method="POST" id="ajaxSubmit" autocomplete="off"
    ...
    <div class="row ">
        ...
        <div class="col-xs-12 col-sm-12 col-md-8">
            <div class="form-group">
                ...
                <input type="text" name="name" placeholder="Clearing Agent Name" class="form-control"
                    autocomplete="off" />
            </div>
        </div>
        <div class="col-xs-12 col-sm-12 col-md-4">
            <div class="form-group">
                ...
                <input type="number" name="rate" placeholder="Rate" class="form-control" step="0.01"
    ...
    <div class="row ">
        ...
        <div class="col-xs-12 col-sm-12 col-md-12">
            <div class="form-group">
                <label>Address:</label>
                <textarea name="address" rows="2" class="form-control" placeholder="Clearing Agent Address"></textarea>
            </div>
        </div>
    </div>
...
<script>
    ...
    $(document).off('click', '.add-more').on('click', '.add-more', function(e) {
        e.preventDefault();
    ...
    $(document).off('click', '.add-more2').on('click', '.add-more2', function(e) {
        e.preventDefault();
