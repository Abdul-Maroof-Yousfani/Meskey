<table class="table m-0">
    ...
    <tbody>
        @if (count($truckSizeRanges) != 0)
            @foreach ($truckSizeRanges as $key => $range)
                <tr>
                    ...
                    <td>
                        ...
                        <a onclick="deletemodal('{{ route('truck-size-ranges.destroy', $range->id) }}','{{ route('get.truck_size_ranges') }}')"
        ...
        @else
            <tr class="ant-table-placeholder">
                <td colspan="5" class="ant-table-cell text-center">
                    <div class="my-5">
