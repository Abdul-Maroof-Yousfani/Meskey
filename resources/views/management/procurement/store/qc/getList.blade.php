                    ...
                    @foreach ($itemGroup['suppliers'] as $supplierRow)
                        ...
                        <tr>
                            ...
                            <div class="d-flex" style="gap: 5px; justify-content: center;">
                                    <a onclick="openModal(this, '{{ route('store.qc.view', ['id' => $supplierRow['data']->id, 'grn' => $requestGroup['request_no']]) }}', 'View QC', false, '100%')"
                                    ...
                                    <a onclick="openModal(this, '{{ route('store.qc.view', ['id' => $supplierRow['data']->id, 'grn' => $requestGroup['request_no'], 'type' => 'view']) }}', 'View QC', false, '100%')"
