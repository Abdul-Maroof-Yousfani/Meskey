            ...
            <table class="table table-bordered" id="purchaseRequestTable">
                ...
                <tbody id="purchaseOrderBody">
                    <tr>
                        ...
                        <td>
                            <input type="text" name="total_weight" id="total_weight" value="Total Weight" readonly
                                class="form-control">
                        </td>
                ...
                <tbody id="purchaseOrderBody">
                    @for ($i = 0; $i < 5; $i++)
                        <tr>
                            ...
                            <td>
                                <input type="text" name="size" id="size" placeholder="Net Weight" readonly
                                    class="form-control">
                            </td>
                            <td>
                                <input type="text" name="brand" id="brand" placeholder="Bag Weight" readonly
                                    class="form-control">
                            </td>
                        </tr>
                    @endfor
...
<div class="row" style="margin-top: 10px; margin-bottom: 30px;">
        <div class="col-md-4">
            <div class="form-group">
                ...
                <input type="text" name="accepted_qty" id="accepted_qty" class="form-control">
            </div>
        </div>
        <div class="col-md-4">
            <div class="form-group">
        ...
        <div class="col-md-4">
            <div class="form-group">
                ...
                <input type="text" name="deduction_per_bag" id="deduction_per_bag" class="form-control">
            </div>
        </div>
    </div>
