                        ...
                        <tr id="row_{{ $key }}">
                            ...
                            <td class="d-flex" style="gap: 10px;">
                                <button style="width: 100px;" type="button" class="btn btn-danger btn-sm removeRowBtn"
                                    ...
                                    <button onclick="editQc('{{ $data->id }}', '{{ $key }}')" @disabled($data->qc?->is_qc_approved == "approved") style="width: 100px;" type="button" class="btn btn-warning btn-sm createQc">Edit QC</button>
