                     ...
                     <tbody id="purchaseRequestBody">
                         <tr id="row_0">
                             ...
                             <td style="width: 10%">
                                 <div class="loop-fields">
                                     <div class="form-group mb-0">
                                         <input type="number" name="qty[]" id="qty_0" class="form-control"
                                             step="0.01" min="0" placeholder="Qty">
                                     </div>
                                 </div>
                             </td>
                             <td style="width: 20%">
         ...
         let row = `
                <tr id="row_${index}">
                    ...
                    <td style="width: 10%">
                        <div class="loop-fields">
                            <div class="form-group mb-0">
                                <input type="number" name="qty[]" id="qty_${index}" class="form-control" step="0.01" min="0" placeholder="Qty">
                            </div>
                        </div>
                    </td>
                    <td style="width: 20%">
                    ...
                    <td style="width: 25%">
                        <input type="text" name="remarks[]" id="remark_${index}" class="form-control" placeholder="Remarks">
                    </td>
                    <td>
