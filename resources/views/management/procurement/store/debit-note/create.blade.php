<form action="{{ route('store.debit-note.store') }}" method="POST" id="ajaxSubmit" autocomplete="off">
    @csrf
        ...
        <div class="col-md-6">
            <div class="form-group">
                ...
                <select class="form-control select2" name="grn_id" id="grn_id">
                    ...
                    @foreach ($grns as $grn)
                        <option value="{{ $grn->id }}">{{ $grn->purchase_order_receiving_no }}</option>
                    @endforeach
                </select>
            </div>
        </div>
        ...
        <div class="col-md-6">
         ...
         <div class="col-md-6">
            <div class="form-group">
                ...
                <input type="text" name="reference_number" readonly id="reference_number" class="form-control">
            </div>
        </div>
    </div>
    ...
    <div class="row form-mar">
        <div class="col-md-12">
            <div id="debitNoteItems" style="display: none;">
