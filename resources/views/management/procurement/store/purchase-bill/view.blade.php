...
<div class="row form-mar">
    <div class="col-md-3">
        <div class="form-group">
            ...
            <select readonly id="supplier_id" name="supplier_id" class="form-control item-select select2">
    ...
    <div class="col-md-3">
        <div class="form-group">
            <label>GRN:</label>
            <select class="form-control select2" name="grn_no" id="grn_no" readonly>
                <option value="">Select GRN</option>
                <option value="" selected>{{ $purchase_bill->grn->purchase_order_receiving_no }}</option>
            </select>
        </div>
    </div>
    ...
    <div class="col-md-3">
        <div class="form-group">
            ...
            <input type="date" id="purchase_date" value="{{ $purchase_bill->bill_date }}" name="purchase_date"
    ...
    <div class="col-md-3">
        <div class="form-group">
            ...
            <input type="text" name="reference_no" value="{{ $purchase_bill->reference_no }}"
                placeholder="Please select location and date." readonly id="reference_no" class="form-control">
        </div>
    </div>
    <div class="col-md-3">
        <div class="form-group">
            ...
            @php
                $locations = $purchase_bill->location_id; 
            @endphp
            <select name="company_location" id="company_location_id" class="form-control select2" multiple readonly>
                ...
                @foreach (get_locations() as $value)
                    <option value="{{ $value->id }}" @selected($value->id == $locations)>{{ $value->name }}</option>
                @endforeach
    ...
    <div class="col-xs-12 col-sm-12 col-md-12 row">
        <div class="form-group col-6">
            ...
            <textarea name="description" id="description" placeholder="Description" class="form-control" readonly>{{ $purchase_bill->description }}</textarea>
        </div>
    </div>
</div>
<div class="row form-mar">
                    ...
                    <tr id="row_{{ $key }}">
                        ...
                        <td style="width: 320px; min-width: 320px;">
                            <input type="text" style="width: 100%;" 
                                   name="item[]" 
                                   value="{{ getItem($data->item_id)?->name }}"
                                   id="item_{{ $key }}" 
                        ...
                        <td style="width: 360px; min-width: 360px;">
                            <input type="text" style="width: 100%;" 
                                   name="description[]" 
                        ...
                        <td style="width: 140px; min-width: 140px;">
                            <input style="width: 100%;" 
                                   ...
                                   id="discount_percent_{{ $key }}"
                                   class="form-control discounts" 
                                   onkeyup="calculatePercentage(this)" 
                                   step="0.01" 
                                   min="0">
                        </td>
                        ...
                        <td style="width: 110px; min-width: 110px; text-align: center; vertical-align: middle;">
                            <button type="button" 
                                    class="btn btn-danger btn-sm removeRowBtn"
                                    onclick="remove({{ $key }})"
                                    data-id="{{ $key }}" 
