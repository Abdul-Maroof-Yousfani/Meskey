    ...
    @slot('body')
        ...
        @foreach ($tickets as $row)
            @php
                ...
                $totalArrivedWeight += $row->arrived_net_weight ?? 0;
            @endphp
            <tr
...
<div class="sticky-footer"
    style="
        ...
        align-items: center;
    ">
    <span class="font-weight-bold mr-2">Total Arrived Weight:</span>
    <span class="font-weight-bold" style="font-size: 18px">{{ $totalArrivedWeight }}</span>
</div>
