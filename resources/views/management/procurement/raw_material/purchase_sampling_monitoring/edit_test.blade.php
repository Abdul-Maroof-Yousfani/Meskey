...
<form action="{{ route('raw-material.sampling-monitoring.update-test', $arrivalSamplingRequest->id) }}" method="POST"
                                    ...
                                    <div class="col-md-2 QcResult">
                                        <div class="input-group mb-0">
                                            <input type="text" readonly class="form-control"
                                                value="{{ number_format((float)($slab->applied_deduction ?? 0), 2) }}">
                                            <div class="input-group-append">
                                                <span class="input-group-text text-sm">{{ SLAB_TYPES_CALCULATED_ON[$slab->slabType->calculation_base_type ?? 1] }}</span>
                                            </div>
                                        </div>
                                        @if(in_array($slab->slabType->calculation_base_type ?? 1, [2, 3]))
                                            <div class="input-group mb-0 mt-1">
                                                <input type="text" readonly class="form-control"
                                                    value="{{ number_format((float)($slab->applied_deduction_maund ?? 0), 3) }}" placeholder="Maund">
                                                <div class="input-group-append">
                            ...
                            @foreach ($innerData['compulsuryResults'] as $slab)
                                ...
                                <div class="form-group row">
                                    ...
                                    @if (!checkIfNameExists($slab->qcParam->name))
                                        <div class="col-md-2 QcResult">
                                            <div class="input-group mb-0">
                                                <input type="text" class="form-control" readonly value="{{ number_format((float)($slab->applied_deduction ?? 0), 2) }}">
                                                <div class="input-group-append">
                                                    <span class="input-group-text text-sm">{{ SLAB_TYPES_CALCULATED_ON[$slab->qcParam->calculation_base_type ?? 1] }}</span>
                                                </div>
                                            </div>
                                            @if(in_array($slab->qcParam->calculation_base_type ?? 1, [2, 3]))
                                                <div class="input-group mb-0 mt-1">
                                                    <input type="text" readonly class="form-control"
                                                        value="{{ number_format((float)($slab->applied_deduction_maund ?? 0), 3) }}" placeholder="Maund">
                                                    <div class="input-group-append">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col">
                                <div class="input-group mb-2">
                                    <input type="text" class="form-control" disabled placeholder="Suggested Sum" value="">
                                    <div class="input-group-append">
                                        <span class="input-group-text text-sm">Rs.</span>
                                    </div>
                                </div>
                            ...
                            <div class="col">
                                <div class="input-group mb-2">
                                    <input type="text" class="form-control" readonly
                                        value="{{ number_format((float)($innerData['request']->lumpsum_deduction ?? 0), 2) }}" placeholder="Lumpsum Deduction">
                                    <div class="input-group-append">
                                        <span class="input-group-text text-sm">Rs.</span>
                                    </div>
                                </div>
                                <div class="input-group mb-2 mt-1">
                                    <input type="text" class="form-control" readonly
                                        value="{{ number_format((float)($innerData['request']->lumpsum_deduction_maund ?? 0), 2) }}" placeholder="Maund (Rs)">
                                    <div class="input-group-append">
                                        <span class="input-group-text text-sm">Maund</span>
                                    </div>
                                </div>
                                <div class="input-group mb-0">
                                    <input type="text" class="form-control" readonly
                                        value="{{ number_format((float)($innerData['request']->lumpsum_deduction_kgs ?? 0), 2) }}" placeholder="Lumpsum Deduction">
                                    <div class="input-group-append">
                                ...
                                <div class="input-group mb-0 mt-1">
                                    <input type="text" class="form-control" readonly
                                        value="{{ number_format((float)($innerData['request']->lumpsum_deduction_kgs_maund ?? 0), 2) }}" placeholder="Maund (KGs)">
                                    <div class="input-group-append">
                                        <span class="input-group-text text-sm">Maund</span>
                                    </div>
                                </div>
            ...
            <div class="tab-pane fade show active" id="current-inner" role="tabpanel"
                    ...
                    @if (count($results) != 0)
                        @foreach ($results as $slab)
                            ...
                            <div class="form-group row checklist-box">
                                ...
                                <div class="col-md-2 QcResult">
                                    <div class="input-group mb-0">
                                        <input type="text" id="deduction-{{ $slab->slabType->id }}" data-maund-target="#maund-deduction-{{ $slab->slabType->id }}"
                                    ...
                                    @if(in_array($slab->slabType->calculation_base_type, [2, 3]))
                                        <div class="input-group mb-0 mt-1">
                                            <input type="text" id="maund-deduction-{{ $slab->slabType->id }}"
                                                ...
                                                value="{{ number_format((float)($slab->applied_deduction_maund ?? 0), 3) }}" placeholder="Maund" data-value-target="#deduction-{{ $slab->slabType->id }}">
                                            <div class="input-group-append">
                                                <span class="input-group-text text-sm">Maund</span>
                                            </div>
                                        </div>
                                        ...
                                        @if(in_array($slab->qcParam->calculation_base_type, [2, 3]))
                                            <div class="input-group mb-0 mt-1">
                                                <input type="text" id="maund-inp-{{ $slab->qcParam->id }}"
                                                    ...
                                                    value="{{ number_format((float)($slab->applied_deduction_maund ?? 0), 3) }}" placeholder="Maund" data-value-target="#inp-{{ $slab->qcParam->id }}">
                                                <div class="input-group-append">
                                                    <span class="input-group-text text-sm">Maund</span>
                                                </div>
                                            </div>
                ...
                <div class="striped-rows mt-3">
                    <div class="form-group row">
                        ...
                        <div class="col">
                            <div class="input-group mb-2">
                                <input type="text" id="lumpsum-value" class="form-control" name="lumpsum_deduction" {{ $latestIsLumpsum ? '' : 'readonly' }} data-maund-target="#lumpsum-maund-value" {{--
                            ...
                            <div class="input-group mb-2 mt-1">
                                <input type="text" id="lumpsum-maund-value" class="form-control lumpsum-maund-field"
                                    name="lumpsum_deduction_maund" {{ $latestIsLumpsum ? '' : 'readonly' }}
                                    value="{{ $arrivalSamplingRequest->lumpsum_deduction_maund ?? 0 }}" placeholder="Maund (Rs)" data-value-target="#lumpsum-value">
                                <div class="input-group-append">
                                    <span class="input-group-text text-sm">Maund</span>
                                </div>
                            </div>
                            <div class="input-group mb-0">
                                <input type="text" id="lumpsum-kgs-value" class="form-control" data-maund-target="#lumpsum-kgs-maund-value"
                            ...
                            <div class="input-group mb-0 mt-1">
                                <input type="text" id="lumpsum-kgs-maund-value" class="form-control lumpsum-maund-field"
                                    name="lumpsum_deduction_kgs_maund" {{ $latestIsLumpsum ? '' : 'readonly' }}
                                    value="{{ $arrivalSamplingRequest->lumpsum_deduction_kgs_maund ?? 0 }}" placeholder="Maund (KGs)" data-value-target="#lumpsum-kgs-value">
                                <div class="input-group-append">
                                    <span class="input-group-text text-sm">Maund</span>
                                </div>
                            </div>
...
<script>
    ...
    $(document).on('input', '.deduction-field, #lumpsum-value, #lumpsum-kgs-value', function() {
        ...
        if(maundTarget && $(maundTarget).length > 0) {
            let maundValue = value * 40;
            $(maundTarget).val(maundValue.toFixed(3));
        }
    });

    $(document).on('input', '.deduction-maund-field, .lumpsum-maund-field, .maund-field', function() {
    ...
    $(document).on('input', '.deduction-field, .maund-field, .deduction-maund-field', function() {
        setTimeout(function() {
            ...
            if ($(this).is(':checked')) {
                Swal.fire({
                    ...
                    if (result.isConfirmed) {
                        ...
                        $('.maund-field').val('0').prop('readonly', true);
                        $('#lumpsum-value').prop('readonly', false);
                        $('#lumpsum-kgs-value').prop('readonly', false);
                        $('#lumpsum-maund-value').prop('readonly', false);
                        $('#lumpsum-kgs-maund-value').prop('readonly', false);
                        calculateTotal();
                    } else {
                ...
                $('.maund-field').prop('readonly', false);
                $('#lumpsum-value').prop('readonly', true).val('0');
                $('#lumpsum-kgs-value').prop('readonly', true).val('0');
                $('#lumpsum-maund-value').prop('readonly', true).val('0');
                $('#lumpsum-kgs-maund-value').prop('readonly', true).val('0');
                calculateTotal();
            }
        });
