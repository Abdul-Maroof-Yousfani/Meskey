    ...
    <div class="row">
        ...
        <div class="col-xs-4 col-sm-4 col-md-4">
            <div class="form-group ">
                ...
                <input type="number" step="0.0001" name="rate_per_kg" placeholder="Rate Per KG" class="form-control" />
        ...
        <div class="col-xs-4 col-sm-4 col-md-4">
            <div class="form-group ">
                ...
                <input type="number" step="0.0001" name="rate_per_mound" placeholder="Rate Per Mound"
                    class="form-control" />
        ...
        <div class="col-xs-4 col-sm-4 col-md-4">
            <div class="form-group ">
                ...
                <input type="number" step="0.0001" name="rate_per_100kg" placeholder="Rate Per 100KG"
                    class="form-control" />
            </div>
        </div>
    </div>
