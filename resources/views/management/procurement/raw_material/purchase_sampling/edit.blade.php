    ...
    <div class="row form-mar">
        ...
        <div class="col-xs-12 col-sm-12 col-md-12">
            <div class="form-group">
                ...
                <input type="text" readonly name="purchase_contract" placeholder="Product" class="form-control"
                    autocomplete="off"
                    value="{{ $PurchaseSamplingRequest->purchaseOrder->qcProduct->name ?? 'N/A' }}" />
            </div>
        </div>
    </div>
            ...
            <div class="form-group ">
                ...
                <select name="sample_taken_by" id="sample_taken_by" class="form-control select2">
                    ...
                    @foreach ($sampleTakenByUsers as $sampleTakenUser)
                        <option @selected($PurchaseSamplingRequest->sample_taken_by == $sampleTakenUser->id) value="{{ $sampleTakenUser->id }}">
        ...
        <div class="col-12 px-3">
            <div class="form-group ">
                ...
                <select name="party_ref_no" id="party_ref_no" class="form-control select2">
                    <option value="{{ $PurchaseSamplingRequest->party_ref_no }}">
                        {{ $PurchaseSamplingRequest->party_ref_no }}</option>
                </select>
            </div>
        </div>
    </div>
    ...
    <div class="row ">
        <div class="col-xs-12 col-sm-12 col-md-12">
            <div class="form-group ">
                ...
                <textarea name="remarks" row="4" class="form-control" placeholder="Description">{{ $PurchaseSamplingRequest->remark }}</textarea>
            </div>
        </div>
    </div>
