<form action="{{ route('raw-material.payment-request.store') }}" method="POST" id="paymentRequestForm"
        ...
        <div class="col-md-3">
            <div class="form-group">
                ...
                <input type="text" class="form-control bg-light"
                    value="{{ $ticket->created_at->format('d-M-Y') ?? 'N/A' }}" readonly>
            </div>
        </div>
        <div class="col-md-3">
            <div class="form-group">
    ...
    <div class="row">
        <div class="col-md-8">
            <div class="form-group">
                <label class="font-weight-bold">Good Received Note</label>
                <input type="text" class="form-control bg-light" value="N/A" readonly>
            </div>
        </div>
        <div class="col-md-4">
            <div class="form-group">
                ...
                <input type="text" class="form-control bg-light"
                    value="{{ $ticket->purchaseOrder->contract_no ?? 'N/A' }}" readonly>
            </div>
        </div>
    </div>
    ...
    <div class="row">
        ...
        <div class="col-md-4">
            <div class="form-group">
                ...
                <input type="text" class="form-control bg-light"
                    value="{{ $ticket->purchaseOrder->supplier->name ?? 'N/A' }}" readonly>
            </div>
        </div>
        <div class="col-md-4">
            <div class="form-group">
        ...
        <div class="col-md-4">
            <div class="form-group">
                ...
                <input type="text" class="form-control editable-field" name="freight_party_name"
                    value="{{ $ticket->freight->freight_party_name ?? '' }}">
            </div>
        </div>
    </div>
        ...
        <div class="col-md-4">
            <div class="form-group">
                ...
                <input type="text" class="form-control editable-field" name="contract_rate"
                    value="{{ $ticket->purchaseOrder->rate_per_kg ?? '0' }}">
            </div>
        </div>
    </div>
        ...
        <div class="col-md-3">
            <div class="form-group">
                ...
                <input type="text" class="form-control editable-field" name="loading_kanta"
                    value="{{ $ticket->purchaseFreight->kanta_charges ?? '0' }}">
            </div>
        </div>
        <div class="col-md-3">
            <div class="form-group">
                ...
                <input type="text" class="form-control editable-field" name="arrived_kanta"
                    value="{{ $ticket->freight->karachi_kanta_charges ?? '0' }}">
            </div>
        </div>
    </div>
        ...
        <div class="col-md-3">
            <div class="form-group">
                ...
                <input type="text" class="form-control editable-field" name="other_labour_positive"
                    value="{{ $ticket->freight->other_labour_charges ?? '0' }}">
            </div>
        </div>
        <div class="col-md-3">
            <div class="form-group">
        ...
        <div class="col-md-3">
            <div class="form-group">
                ...
                <input type="text" class="form-control editable-field" name="market_comm"
                    value="{{ $ticket->freight->market_comm ?? '0' }}">
            </div>
        </div>
    </div>
        ...
        <div class="col-md-3">
            <div class="form-group">
                ...
                <input type="text" class="form-control editable-field" name="over_weight_ded"
                    value="{{ $ticket->freight->over_weight_ded ?? '0' }}">
            </div>
        </div>
        <div class="col-md-3">
            <div class="form-group">
                ...
                <input type="text" class="form-control editable-field" name="godown_penalty"
                    value="{{ $ticket->freight->godown_penalty ?? '0' }}">
            </div>
        </div>
        <div class="col-md-3">
            <div class="form-group">
        ...
        <div class="col-md-3">
            <div class="form-group">
                ...
                <input type="text" class="form-control editable-field" name="extra_ded"
                    value="{{ $ticket->freight->extra_ded ?? '0' }}">
            </div>
        </div>
    </div>
    <div class="row">
        <div class="col-md-3">
            <div class="form-group">
                ...
                <input type="text" class="form-control editable-field" name="commission_ded"
                    value="{{ $ticket->freight->commission_ded ?? '0' }}">
            </div>
        </div>
    </div>
