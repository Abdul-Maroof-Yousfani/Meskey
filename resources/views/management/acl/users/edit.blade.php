...
<div id="card-container" class="mb-4">
    @foreach (getUserAllCompanies($user->id) as $assignedCompany)
                    ...
                    <div class="form-group m-0">
                        ...
                        <select name="company[]" class="form-control">
                            @foreach (getAllCompanies() as $company)
                                <option {{ $company->id == $assignedCompany->id ? 'selected' : '' }}
                    ...
                    <div class="form-group m-0">
                        ...
                        <select name="role[]" class="form-control">
                            @foreach ($roles as $role)
                                <option {{ $assignedCompany->pivot->role_id == $role->id ? 'selected' : '' }}
